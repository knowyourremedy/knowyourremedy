...
export const BATCH50_PAIN_FEVER_LIST3: RatingRecord[] = [
  ...
  row({
    ...
    brand: 'Biofreeze',
    category: PAIN_FEVER,
    barcode: '731124000040 731124120014',
...
const BATCH50_CATCHUP_BARCODES: Record<string, string> = {
  ...
  [ID.colorlessGel]: '731124000040 731124120014',
  [ID.colorlessRoll]: '731124120007',
  [ID.proGel]: '731124000248',
  [ID.proRoll]: '731124000231',
  [ID.ovnGel]: '731124444141',
  [ID.ovnRoll]: '731124444158',
  [ID.sprayAlc]: '731124000071',
  [ID.proSprayAlc]: '731124000255',
  [ID.pen]: '731124003485',
