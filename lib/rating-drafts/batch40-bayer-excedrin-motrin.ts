...
export const BATCH40_BAYER_EXCEDRIN_MOTRIN: RatingRecord[] = [
  ...
  row({
    ...
    brand: 'Bayer',
    category: PAIN_FEVER,
    barcode: '312843558540 312843510500 312843555402',
  ...
  row({
    ...
    brand: 'Bayer',
    category: PAIN_FEVER,
    barcode: '312843061323 312843536371 312843536401 312843536425 312843555655',
  ...
  row({
    ...
    brand: 'Excedrin',
    category: PAIN_FEVER,
    barcode: '300672039835 300672039248 300672039910 300672039927',
  ...
  row({
    ...
    brand: 'Excedrin',
    category: SLEEP,
    barcode: '300672056245 300672056917',
    formulaId: ID.pm,
    audience: ADULT,
    minAge: 12,
    form: 'coated tablet',
