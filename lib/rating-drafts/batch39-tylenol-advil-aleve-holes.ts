...
export const BATCH39_TYLENOL_ADVIL_ALEVE_HOLES: RatingRecord[] = [
  ...
  row({
    ...
    brand: 'Aleve',
    category: PAIN_FEVER,
    barcode: '025866592261 025866591998 025866592230 025866592247 025866592025 025866593015 025866591981 025866592018',
  ...
  row({
    ...
    brand: 'Aleve',
    category: PAIN_FEVER,
    barcode: '025866591967 025866591943 025866591936 025866591950',
  ...
  row({
    ...
    brand: 'Aleve',
    category: SLEEP,
    barcode: '025866591882 025866591905 025866591899',
  ...
  row({
    ...
    brand: 'Aleve',
    category: PAIN_FEVER,
    barcode: '025866592254 025866592001 025866592032',
  ...
  row({
    ...
    brand: 'Motrin',
    category: PAIN_FEVER,
    barcode: '300450409126 300450409201 300450409805',
