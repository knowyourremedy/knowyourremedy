...
const COMPACT: Compact[] = [
  ...
  },
  {
    ...
    verdict: "clean",
    note: CLEAN_NOTE + " This 180 Count graphic does not print a GTIN-12, so no UPC is attached. The 90 Count barcode is not copied onto this count.",
