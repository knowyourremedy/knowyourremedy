...
const SINGLE_TUBES: RatingRecord[] = [
  ...
  singleTube('abiescanadensis', 'Abiescanadensis', PAIN_FEVER),
  singleTube('abiesnigra', 'Abiesnigra', DIGESTIVE),
  ...
  singleTube('aethusacynapium', 'Aethusacynapium', PAIN_FEVER),
  singleTube('agaricusmuscarius', 'Agaricusmuscarius', PAIN_FEVER),
  singleTube('agraphisnutans', 'Agraphisnutans', PAIN_FEVER),
  singleTube('ailanthusglandulosus', 'Ailanthusglandulosus', PAIN_FEVER),
  singleTube('alfalfa', 'Alfalfa', PAIN_FEVER),
  singleTube('allium-cepa', 'Allium Cepa', COLD_FLU),
  singleTube('alliumsativum', 'Alliumsativum', COLD_FLU),
  singleTube('aloe', 'Aloe', DIGESTIVE),
  singleTube('alumen', 'Alumen', PAIN_FEVER),
  singleTube('alumina', 'Alumina', PAIN_FEVER),
  singleTube('aluminasilicata', 'Aluminasilicata', PAIN_FEVER),
  singleTube('aluminiummetallicum', 'Aluminiummetallicum', PAIN_FEVER),
  singleTube('ambrosiaartemisiaefolia', 'Ambrosiaartemisiaefolia', ALLERGIES),
  singleTube('ammoniumcarbonicum', 'Ammoniumcarbonicum', PAIN_FEVER),
  singleTube('ammoniummuriaticum', 'Ammoniummuriaticum', PAIN_FEVER),
  singleTube('ammoniumphosphoricum', 'Ammoniumphosphoricum', PAIN_FEVER),
  singleTube('amylnitrosum', 'Amylnitrosum', PAIN_FEVER),
  singleTube('anacardiumoccidentale', 'Anacardiumoccidentale', PAIN_FEVER),
  singleTube('anacardiumorientale', 'Anacardiumorientale', PAIN_FEVER),
  singleTube('anagallisarvensis', 'Anagallisarvensis', PAIN_FEVER),
  singleTube('anatherummuricatum', 'Anatherummuricatum', PAIN_FEVER),
  singleTube('antimonium-crudum', 'Antimonium Crudum', PAIN_FEVER),
  singleTube('antimonium-tartaricum', 'Antimonium Tartaricum', COLD_FLU),
  singleTube('antimoniumiodatum', 'Antimoniumiodatum', PAIN_FEVER),
  singleTube('apis-mellifica', 'Apis Mellifica', FIRST_AID),
  singleTube('apisvenenumpurum', 'Apisvenenumpurum', PAIN_FEVER),
  singleTube('aquamarina', 'Aquamarina', PAIN_FEVER),
  singleTube('araliaracemosa', 'Araliaracemosa', PAIN_FEVER),
  singleTube('argentum-nitricum', 'Argentum Nitricum', PAIN_FEVER),
  singleTube('argentummetallicum', 'Argentummetallicum', PAIN_FEVER),
  singleTube('aristolochiaclematitis', 'Aristolochiaclematitis', PAIN_FEVER),
  singleTube('arnicamontanaradix', 'Arnica montana radix', PAIN_FEVER),
  singleTube('arsenicum-album', 'Arsenicum Album', DIGESTIVE),
  singleTube('arsenicumbromatum', 'Arsenicumbromatum', PAIN_FEVER),
  singleTube('arsenicumiodatum', 'Arsenicumiodatum', PAIN_FEVER),
  singleTube('arsenicummetallicum', 'Arsenicummetallicum', PAIN_FEVER),
  singleTube('arssulphflav', 'Arssulphflav', PAIN_FEVER),
  singleTube('arssulphrubrum', 'Arssulphrubrum', PAIN_FEVER),
  singleTube('artemisiavulgaris', 'Artemisiavulgaris', PAIN_FEVER),
  singleTube('arum-triphyllum', 'Arum Triphyllum', PAIN_FEVER),
  singleTube('arummaculatum', 'Arummaculatum', PAIN_FEVER),
  singleTube('arundomauritanica', 'Arundomauritanica', ALLERGIES),
  singleTube('asafoetida', 'Asafoetida', PAIN_FEVER),
  singleTube('asarumeuropaeum3c', 'Asarumeuropaeum3c', PAIN_FEVER),
  singleTube('asteriasrubens', 'Asteriasrubens', PAIN_FEVER),
  singleTube('aurumiodatum', 'Aurumiodatum', PAIN_FEVER),
  singleTube('aurummetallicum', 'Aurummetallicum', PAIN_FEVER),
  singleTube('aurummuriaticum', 'Aurummuriaticum', PAIN_FEVER),
  singleTube('aurummuriatnatronatum', 'Aurummuriatnatronatum', PAIN_FEVER),
  singleTube('avenasativa', 'Avenasativa', SLEEP),
  singleTube('baptisiatinctoria', 'Baptisiatinctoria', COLD_FLU),
  singleTube('barytacarbonica', 'Barytacarbonica', PAIN_FEVER),
  singleTube('barytaiodata', 'Barytaiodata', PAIN_FEVER),
  singleTube('barytamuriatica', 'Barytamuriatica', PAIN_FEVER),
  singleTube('belladonna', 'Belladonna', PAIN_FEVER),
  singleTube('bellisperennis', 'Bellisperennis', FIRST_AID),
  singleTube('benzinum', 'Benzinum', PAIN_FEVER),
  singleTube('benzoicumacidum', 'Benzoicumacidum', PAIN_FEVER),
  singleTube('berberisaquifolium', 'Berberisaquifolium', PAIN_FEVER),
  singleTube('berberisvulgaris', 'Berberisvulgaris', PAIN_FEVER),
  singleTube('berylliummetallicum', 'Berylliummetallicum', PAIN_FEVER),
  singleTube('bismuthummetallicum', 'Bismuthummetallicum', PAIN_FEVER),
  singleTube('bismuthumsubnitricum', 'Bismuthumsubnitricum', PAIN_FEVER),
  singleTube('blattaorientalis', 'Blattaorientalis', PAIN_FEVER),
  ...
  singleTube('cadmiummetallicum', 'Cadmiummetallicum', PAIN_FEVER),
  singleTube('cadmiumsulphuratum', 'Cadmiumsulphuratum', PAIN_FEVER),
  singleTube('cadmiumsulphuricum', 'Cadmiumsulphuricum', PAIN_FEVER),
  singleTube('cajuputum', 'Cajuputum', PAIN_FEVER),
  singleTube('caladiumseguinum', 'Caladiumseguinum', PAIN_FEVER),
  ...
  singleTube('calcareaiodata', 'Calcareaiodata', PAIN_FEVER),
  singleTube('calcareasilicata', 'Calcareasilicata', PAIN_FEVER),
  singleTube('calendulaofficinalis', 'Calendula officinalis', FIRST_AID),
  singleTube('camphora', 'Camphora', PAIN_FEVER),
  singleTube('candidaalbicans', 'Candidaalbicans', PAIN_FEVER),
  singleTube('cantharis', 'Cantharis', FIRST_AID),
  singleTube('capsicumannuum', 'Capsicumannuum', PAIN_FEVER),
  singleTube('carbo-vegetabilis', 'Carbo Vegetabilis', DIGESTIVE),
  singleTube('carboanimalis', 'Carboanimalis', PAIN_FEVER),
  singleTube('carbolicumacidum', 'Carbolicumacidum', PAIN_FEVER),
  singleTube('carboneumsulphuratum', 'Carboneumsulphuratum', PAIN_FEVER),
  singleTube('carduusmarianus', 'Carduusmarianus', PAIN_FEVER),
  ...
  singleTube('cenchriscontortrix', 'Cenchriscontortrix', PAIN_FEVER),
  singleTube('chamomilla', 'Chamomilla', PAIN_FEVER),
  singleTube('cheiranthuscheiri', 'Cheiranthuscheiri', PAIN_FEVER),
  ...
  singleTube('chininumarsenicosum', 'Chininumarsenicosum', PAIN_FEVER),
  singleTube('chininumsalicylicum', 'Chininumsalicylicum', PAIN_FEVER),
  singleTube('chininumsulphuricum', 'Chininumsulphuricum', PAIN_FEVER),
  singleTube('chionanthus-virginica', 'Chionanthus Virginica', PAIN_FEVER),
  singleTube('chlorinum', 'Chlorinum', PAIN_FEVER),
  singleTube('cicutavirosa', 'Cicutavirosa', PAIN_FEVER),
  ...
  singleTube('cinerariamaritima', 'Cinerariamaritima', PAIN_FEVER),
  singleTube('cinnamomum', 'Cinnamomum', PAIN_FEVER),
  singleTube('cobaltummetallicum', 'Cobaltummetallicum', PAIN_FEVER),
  singleTube('cocculus-indicus', 'Cocculus Indicus', DIGESTIVE),
  singleTube('coccuscacti', 'Coccuscacti', COLD_FLU),
  singleTube('coffea-cruda', 'Coffea Cruda', SLEEP),
  singleTube('coffeatosta', 'Coffeatosta', SLEEP),
  singleTube('colchicumautumnale', 'Colchicumautumnale', PAIN_FEVER),
  singleTube('collinsoniacanadensis', 'Collinsoniacanadensis', DIGESTIVE),
  singleTube('colocynthis', 'Colocynthis', DIGESTIVE),
  singleTube('condurango', 'Condurango', PAIN_FEVER),
  singleTube('coniummaculatum', 'Coniummaculatum', PAIN_FEVER),
  singleTube('coralliumrubrum', 'Coralliumrubrum', PAIN_FEVER),
  singleTube('cortisoneaceticum', 'Cortisoneaceticum', PAIN_FEVER),
  singleTube('crocussativus', 'Crocussativus', PAIN_FEVER),
  singleTube('croton-tiglium', 'Croton Tiglium', PAIN_FEVER),
  singleTube('cuprum-metallicum', 'Cuprum Metallicum', PAIN_FEVER),
  singleTube('cuprumaceticum', 'Cuprumaceticum', PAIN_FEVER),
  singleTube('cuprumarsenicosum', 'Cuprumarsenicosum', PAIN_FEVER),
  singleTube('cuprumoxydatumnigrum', 'Cuprumoxydatumnigrum', PAIN_FEVER),
  ...
  singleTube('dioscoreavillosa', 'Dioscoreavillosa', PAIN_FEVER),
  singleTube('dolichospruriens', 'Dolichospruriens', PAIN_FEVER),
  singleTube('drosera', 'Drosera', COLD_FLU),
  singleTube('dulcamara', 'Dulcamara', COLD_FLU),
  singleTube('echinacea', 'Echinacea', PAIN_FEVER),
  singleTube('echinaceapurpurea', 'Echinaceapurpurea', PAIN_FEVER),
  singleTube('elapscorallinus', 'Elapscorallinus', PAIN_FEVER),
  singleTube('equisetumarvense', 'Equisetumarvense', PAIN_FEVER),
  singleTube('equisetumhyemale', 'Equisetumhyemale', PAIN_FEVER),
  singleTube('erigeroncanadensis', 'Erigeroncanadensis', PAIN_FEVER),
  singleTube('eucalyptusglobulus', 'Eucalyptusglobulus', COLD_FLU),
  singleTube('eugeniajambosa', 'Eugeniajambosa', PAIN_FEVER),
  ...
  singleTube('fagopyrumesculentum', 'Fagopyrumesculentum', PAIN_FEVER),
  singleTube('ferrum-phosphoricum', 'Ferrum Phosphoricum', COLD_FLU),
  singleTube('ferrummetallicum', 'Ferrummetallicum', PAIN_FEVER),
  singleTube('ferrumpicricum', 'Ferrumpicricum', PAIN_FEVER),
  singleTube('ferrumsulphuricum', 'Ferrumsulphuricum', PAIN_FEVER),
  singleTube('filixmas', 'Filixmas', PAIN_FEVER),
  singleTube('folliculinum', 'Folliculinum', PAIN_FEVER),
  singleTube('formicarufa', 'Formicarufa', PAIN_FEVER),
  singleTube('fragariavesca', 'Fragariavesca', PAIN_FEVER),
  singleTube('fucusvesiculosus', 'Fucusvesiculosus', PAIN_FEVER),
  singleTube('fumariaofficinalis', 'Fumariaofficinalis', PAIN_FEVER),
  singleTube('gallicumacidum', 'Gallicumacidum', PAIN_FEVER),
  singleTube('galphimia-glauca', 'Galphimia Glauca', ALLERGIES),
  singleTube('gelsemium-sempervirens', 'Gelsemium Sempervirens', COLD_FLU),
  singleTube('geraniummaculatum', 'Geraniummaculatum', PAIN_FEVER),
  singleTube('glonoinum', 'Glonoinum', PAIN_FEVER),
  singleTube('gnaphalium-polycephalum', 'Gnaphalium Polycephalum', PAIN_FEVER),
  singleTube('gossypiumherbaceum', 'Gossypiumherbaceum', PAIN_FEVER),
  singleTube('granatum', 'Granatum', PAIN_FEVER),
  singleTube('graphites', 'Graphites', PAIN_FEVER),
  singleTube('gratiolaofficinalis', 'Gratiolaofficinalis', PAIN_FEVER),
  ...
  singleTube('heklalava', 'Heklalava', FIRST_AID),
  singleTube('helleborusniger', 'Helleborusniger', PAIN_FEVER),
  singleTube('heloniasdioica', 'Heloniasdioica', PAIN_FEVER),
  singleTube('hepar-sulphuris-calcareum', 'Hepar Sulphuris Calcareum', COLD_FLU),
  singleTube('hepaticatriloba', 'Hepaticatriloba', PAIN_FEVER),
  singleTube('histaminum-hydrochloricum', 'Histaminum Hydrochloricum', ALLERGIES),
  singleTube('hurabrasiliensis', 'Hurabrasiliensis', PAIN_FEVER),
  singleTube('hydrastis-canadensis', 'Hydrastis Canadensis', COLD_FLU),
  singleTube('hydrocotyleasiatica', 'Hydrocotyleasiatica', PAIN_FEVER),
  singleTube('hydrocyanicumacidum', 'Hydrocyanicumacidum', PAIN_FEVER),
  singleTube('hydrofluoricumacidum', 'Hydrofluoricumacidum', PAIN_FEVER),
  singleTube('hyoscyamusniger', 'Hyoscyamusniger', SLEEP),
  singleTube('hypericum-perforatum', 'Hypericum Perforatum', FIRST_AID),
  singleTube('iberisamara', 'Iberisamara', PAIN_FEVER),
  ...
  singleTube('irisversicolor', 'Irisversicolor', PAIN_FEVER),
  singleTube('jalapa', 'Jalapa', DIGESTIVE),
  singleTube('juglansregia', 'Juglansregia', PAIN_FEVER),
  ...
  singleTube('kaliarsenicosum', 'Kaliarsenicosum', PAIN_FEVER),
  singleTube('kalibromatum', 'Kalibromatum', PAIN_FEVER),
  singleTube('kalichloricum', 'Kalichloricum', PAIN_FEVER),
  singleTube('kalmialatifolia', 'Kalmialatifolia', PAIN_FEVER),
  singleTube('kreosotum', 'Kreosotum', PAIN_FEVER),
  singleTube('laccaninum', 'Laccaninum', PAIN_FEVER),
  singleTube('lacdefloratum', 'Lacdefloratum', PAIN_FEVER),
  singleTube('lachesis-mutus', 'Lachesis Mutus', PAIN_FEVER),
  singleTube('lachnanthestinctoria', 'Lachnanthestinctoria', PAIN_FEVER),
  singleTube('lacticumacidum', 'Lacticumacidum', PAIN_FEVER),
  singleTube('lactucavirosa', 'Lactucavirosa', PAIN_FEVER),
  singleTube('lathyrussativus', 'Lathyrussativus', PAIN_FEVER),
  singleTube('laurocerasus', 'Laurocerasus', PAIN_FEVER),
  singleTube('ledum-palustre', 'Ledum Palustre', FIRST_AID),
  singleTube('lemnaminor', 'Lemnaminor', PAIN_FEVER),
  singleTube('liliumtigrinum', 'Liliumtigrinum', PAIN_FEVER),
  singleTube('lithiumcarbonicum', 'Lithiumcarbonicum', PAIN_FEVER),
  singleTube('lobelia-inflata', 'Lobelia Inflata', PAIN_FEVER),
  singleTube('luffaoperculata', 'Luffaoperculata', ALLERGIES),
  ...
  singleTube('magnesiacarbonica', 'Magnesiacarbonica', PAIN_FEVER),
  singleTube('magnesiamuriatica', 'Magnesiamuriatica', PAIN_FEVER),
  singleTube('magnesiasulphurica', 'Magnesiasulphurica', PAIN_FEVER),
  singleTube('manganumaceticum', 'Manganumaceticum', PAIN_FEVER),
  singleTube('manganummetallicum', 'Manganummetallicum', PAIN_FEVER),
  singleTube('melilotusofficinalis', 'Melilotusofficinalis', PAIN_FEVER),
  singleTube('melissa-officinalis', 'Melissa Officinalis', PAIN_FEVER),
  singleTube('menyanthestrifoliata', 'Menyanthestrifoliata', PAIN_FEVER),
  singleTube('mercurius-solubilis', 'Mercurius Solubilis', PAIN_FEVER),
  singleTube('mercuriuscorrosivus', 'Mercuriuscorrosivus', PAIN_FEVER),
  singleTube('mercuriuscyanatus', 'Mercuriuscyanatus', PAIN_FEVER),
  singleTube('mercuriusdulcis', 'Mercuriusdulcis', PAIN_FEVER),
  singleTube('mercuriusiodatusruber', 'Mercuriusiodatusruber', PAIN_FEVER),
  singleTube('mercuriussulphruber', 'Mercuriussulphruber', PAIN_FEVER),
  singleTube('mercuriusvivus', 'Mercuriusvivus', PAIN_FEVER),
  singleTube('mezereum', 'Mezereum', PAIN_FEVER),
  singleTube('millefolium', 'Millefolium', PAIN_FEVER),
  singleTube('momordicabalsamina', 'Momordicabalsamina', PAIN_FEVER),
  singleTube('murexpurpurea', 'Murexpurpurea', PAIN_FEVER),
  singleTube('muriaticumacidum', 'Muriaticumacidum', PAIN_FEVER),
  singleTube('mygale', 'Mygale', PAIN_FEVER),
  singleTube('myristicasebifera', 'Myristicasebifera', PAIN_FEVER),
  singleTube('najatripudians', 'Najatripudians', PAIN_FEVER),
  ...
  singleTube('natrumcarbonicum', 'Natrumcarbonicum', PAIN_FEVER),
  singleTube('natrumphosphoricum', 'Natrumphosphoricum', PAIN_FEVER),
  singleTube('niccolummetallicum', 'Niccolummetallicum', PAIN_FEVER),
  singleTube('nitricumacidum', 'Nitricumacidum', PAIN_FEVER),
  singleTube('nux-vomica', 'Nux Vomica', DIGESTIVE),
  singleTube('nuxmoschata', 'Nuxmoschata', SLEEP),
  singleTube('ocimumcanum', 'Ocimumcanum', PAIN_FEVER),
  singleTube('oenanthecrocata', 'Oenanthecrocata', PAIN_FEVER),
  singleTube('oleander', 'Oleander', PAIN_FEVER),
  singleTube('onosmodiumvirginianum', 'Onosmodiumvirginianum', PAIN_FEVER),
  singleTube('ornithogalumumbellatum', 'Ornithogalumumbellatum', PAIN_FEVER),
  singleTube('oxalicumacidum', 'Oxalicumacidum', PAIN_FEVER),
  singleTube('paeoniaofficinalis', 'Paeoniaofficinalis', DIGESTIVE),
  singleTube('palladiummetallicum', 'Palladiummetallicum', PAIN_FEVER),
  singleTube('pareirabrava', 'Pareirabrava', PAIN_FEVER),
  singleTube('parisquadrifolia', 'Parisquadrifolia', PAIN_FEVER),
  singleTube('passifloraincarnata', 'Passifloraincarnata', SLEEP),
  singleTube('petroleum', 'Petroleum', DIGESTIVE),
  singleTube('phellandriumaquaticum', 'Phellandriumaquaticum', PAIN_FEVER),
  singleTube('phosphoricum-acidum', 'Phosphoricum Acidum', PAIN_FEVER),
  singleTube('phosphorus', 'Phosphorus', COLD_FLU),
  singleTube('physostigmavenenosum', 'Physostigmavenenosum', PAIN_FEVER),
  singleTube('phytolacca-decandra', 'Phytolacca Decandra', COLD_FLU),
  singleTube('picricumacidum', 'Picricumacidum', PAIN_FEVER),
  singleTube('pilocarpus', 'Pilocarpus', PAIN_FEVER),
  singleTube('pipermethysticum', 'Pipermethysticum', PAIN_FEVER),
  singleTube('plantagomajor', 'Plantagomajor', PAIN_FEVER),
  singleTube('platinummetallicum', 'Platinummetallicum', PAIN_FEVER),
  singleTube('plumbummetallicum', 'Plumbummetallicum', PAIN_FEVER),
  singleTube('podophyllum-peltatum', 'Podophyllum Peltatum', DIGESTIVE),
  singleTube('polygonumpunctatum', 'Polygonumpunctatum', PAIN_FEVER),
  singleTube('pteleatrifoliata', 'Pteleatrifoliata', PAIN_FEVER),
  ...
  singleTube('radiumbromatum', 'Radiumbromatum', PAIN_FEVER),
  singleTube('ranunculusbulbosus', 'Ranunculusbulbosus', PAIN_FEVER),
  singleTube('raphanussativus', 'Raphanussativus', PAIN_FEVER),
  singleTube('ratanhia', 'Ratanhia', DIGESTIVE),
  singleTube('rheumofficinale', 'Rheumofficinale', DIGESTIVE),
  singleTube('rhododendronchrysanthum', 'Rhododendronchrysanthum', PAIN_FEVER),
  singleTube('rhus-tox', 'Rhus Tox', PAIN_FEVER),
  singleTube('rhusvenenata', 'Rhusvenenata', PAIN_FEVER),
  singleTube('ricinuscommunis', 'Ricinuscommunis', PAIN_FEVER),
  singleTube('robiniapseudoacacia', 'Robiniapseudoacacia', DIGESTIVE),
  ...
  singleTube('saccharumofficinale', 'Saccharumofficinale', PAIN_FEVER),
  singleTube('salicylicumacidum', 'Salicylicumacidum', PAIN_FEVER),
  ...
  singleTube('sanguinariacanadensis', 'Sanguinariacanadensis', PAIN_FEVER),
  singleTube('sanguinarinumnitricum', 'Sanguinarinumnitricum', PAIN_FEVER),
  singleTube('saponariaofficinalis', 'Saponariaofficinalis', PAIN_FEVER),
  singleTube('sarcolacticum-acidum', 'Sarcolacticum Acidum', PAIN_FEVER),
  singleTube('sarsaparilla', 'Sarsaparilla', PAIN_FEVER),
  singleTube('scillamaritima', 'Scillamaritima', COLD_FLU),
  singleTube('scrophularianodosa', 'Scrophularianodosa', PAIN_FEVER),
  singleTube('scutellarialateriflora', 'Scutellarialateriflora', SLEEP),
  singleTube('secalecornutum', 'Secalecornutum', PAIN_FEVER),
  singleTube('seleniummetallicum', 'Seleniummetallicum', PAIN_FEVER),
  singleTube('sempervivumtectorum', 'Sempervivumtectorum', PAIN_FEVER),
  singleTube('senegaofficinalis', 'Senegaofficinalis', COLD_FLU),
  singleTube('senna', 'Senna', PAIN_FEVER),
  singleTube('sepia', 'Sepia', PAIN_FEVER),
  singleTube('silicamarina', 'Silicamarina', PAIN_FEVER),
  singleTube('silicea', 'Silicea', FIRST_AID),
  singleTube('sinapisnigra', 'Sinapisnigra', PAIN_FEVER),
  singleTube('solidagovirgaurea', 'Solidagovirgaurea', ALLERGIES),
  singleTube('spigeliaanthelmia', 'Spigeliaanthelmia', PAIN_FEVER),
  singleTube('spongia-tosta', 'Spongia Tosta', COLD_FLU),
  singleTube('stannummetallicum', 'Stannummetallicum', PAIN_FEVER),
  singleTube('staphysagria', 'Staphysagria', FIRST_AID),
  singleTube('stictapulmonaria', 'Stictapulmonaria', COLD_FLU),
  singleTube('stramonium-2', 'Stramonium', SLEEP),
  singleTube('strontiumcarbonicum', 'Strontiumcarbonicum', PAIN_FEVER),
  singleTube('sulphur', 'Sulphur', PAIN_FEVER),
  singleTube('sulphur-iodatum', 'Sulphur Iodatum', PAIN_FEVER),
  singleTube('sulphuricumacidum', 'Sulphuricumacidum', PAIN_FEVER),
  singleTube('symphoricarpusracemosus', 'Symphoricarpusracemosus', PAIN_FEVER),
  singleTube('symphytum-officinale', 'Symphytum Officinale', FIRST_AID),
  singleTube('tabacum', 'Tabacum', DIGESTIVE),
  singleTube('taraxacumofficinale', 'Taraxacumofficinale', PAIN_FEVER),
  singleTube('tarentulacubensis', 'Tarentulacubensis', PAIN_FEVER),
  singleTube('tarentulahispana', 'Tarentulahispana', PAIN_FEVER),
  singleTube('telluriummetallicum', 'Telluriummetallicum', PAIN_FEVER),
  singleTube('terebinthina', 'Terebinthina', PAIN_FEVER),
  singleTube('teucriummarum', 'Teucriummarum', PAIN_FEVER),
  singleTube('theasinensis', 'Theasinensis', PAIN_FEVER),
  singleTube('theridion', 'Theridion', PAIN_FEVER),
  singleTube('thiosinaminum', 'Thiosinaminum', PAIN_FEVER),
  singleTube('thlaspibursapastoris', 'Thlaspibursapastoris', PAIN_FEVER),
  singleTube('thuja-occidentalis', 'Thuja Occidentalis', FIRST_AID),
  singleTube('thyroidinum', 'Thyroidinum', PAIN_FEVER),
  singleTube('titaniummetallicum', 'Titaniummetallicum', PAIN_FEVER),
  singleTube('trilliumpendulum', 'Trilliumpendulum', PAIN_FEVER),
  singleTube('tuberculinum-residuum', 'Tuberculinum Residuum', PAIN_FEVER),
  singleTube('urtica-urens', 'Urtica Urens', FIRST_AID),
  singleTube('ustilagomaidis', 'Ustilagomaidis', PAIN_FEVER),
  singleTube('uvaursi', 'Uvaursi', PAIN_FEVER),
  singleTube('valerianaofficinalis', 'Valerianaofficinalis', SLEEP),
  singleTube('venusmercenaria', 'Venusmercenaria', PAIN_FEVER),
  singleTube('veratrumalbum', 'Veratrumalbum', DIGESTIVE),
  singleTube('veratrumviride', 'Veratrumviride', PAIN_FEVER),
  singleTube('verbascumthapsus', 'Verbascumthapsus', COLD_FLU),
  singleTube('vespacrabro', 'Vespacrabro', PAIN_FEVER),
  singleTube('viburnumopulus', 'Viburnumopulus', PAIN_FEVER),
  singleTube('violaodorata', 'Violaodorata', PAIN_FEVER),
  singleTube('violatricolor', 'Violatricolor', PAIN_FEVER),
  singleTube('viperaberus', 'Viperaberus', PAIN_FEVER),
  singleTube('viscumalbum', 'Viscumalbum', PAIN_FEVER),
  singleTube('wyethiahelenioides', 'Wyethiahelenioides', ALLERGIES),
  singleTube('xanthoxylumfraxineum', 'Xanthoxylumfraxineum', PAIN_FEVER),
  singleTube('zincum-metallicum', 'Zincum Metallicum', PAIN_FEVER),
  singleTube('zincumsulphuricum', 'Zincumsulphuricum', PAIN_FEVER),
];
...
export const BATCH34_BOIRON: RatingRecord[] = [
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('sinuscalm') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('sinuscalm-allergy') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('voicecalm') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('chestal-cough-mucus') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('diarrheacalm') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('cyclease-cramps') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('cyclease-menopause') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('motioncalm') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('nauseacalm') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('allergycalm') + ' — ' + UNVERIFIED_NOTE,
      shop('allergycalm-kids') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('chestal-kids') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('yeastcalm') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('hemcalm-suppositories') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    sourcesGeneral: [
      shop('chestal-cold-cough-honey') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    sourcesGeneral: [
      shop('chestal-cough-syrup') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    cleanAlternatives: BABY_COLD_ALTS,
    sourcesGeneral: [
      shop('camilia-bedtime') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    retailers: [...BOIRON_RETAILERS],
    sourcesGeneral: [
      shop('camilia-tummy') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    cleanAlternatives: BABY_COLD_ALTS,
    sourcesGeneral: [
      shop('coldcalm-baby') + ' — ' + UNVERIFIED_NOTE,
...

  {
    ...
    verdict: 'caution',
    honestNote: homeoNoteNoLac(
      'FOUNDER-STYLE DRAFT: Arnicare Foot Care = Caution. Same shea panel. Still US (BoironUSA tag in stock). Shop slug arnicare-footcare. Driver is lactobacillus ferment (standalone Caution-table). ' +
        CREAM_OIL_LINE +
        ' Ages 1+.',
    ),
    retailers: [...BOIRON_RETAILERS],
    cleanAlternatives: ARNICARE_GEL_ALTS,
    sourcesGeneral: [
      shop('arnicare-footcare') + ' — ' + UNVERIFIED_NOTE,
