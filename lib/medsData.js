  ...
  export const MEDS = {
    ...
    bergamotOil: {
      ...
      cypressOil: {
        ...
        warnings:{child:'Dilute properly. Not for children under 6. Avoid near face of infants.',adult:'Always dilute before skin application. Avoid in pregnancy (may stimulate circulation). Generally well-tolerated topically; do not ingest.'},
      },
      ...
      helichrysumOil: {
        ...
        formats:{
          liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1 drop or 1% of essential oil per tsp of carrier oil — kids 6+',mgPerUnit:1,unitML:5},{label:'2 drops or 2% of essential oil per tsp of carrier oil — adults',mgPerUnit:2,unitML:5}]},
          liquid2:{label:'Diffusion',concentrations:[{label:'2-4 drops in diffuser (potent scent)',mgPerUnit:2,unitML:1}]},
        },
        source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. Churchill Livingstone 2014 · Worwood VA: Complete Book of Essential Oils 2nd ed. 2016.',
        warnings:{child:'Dilute properly. Not for children under 6.',adult:'Premium specialty oil — among the most expensive essential oils. Traditionally used for bruising and wound healing (sometimes called "immortelle"). Always dilute. Avoid in pregnancy. May interact with blood-thinning medications due to anti-coagulant compounds.'},
      },
      ...
      lemongrassOil: {
        ...
        formats:{
          ...
          liquid2:{label:'Diffusion / Bug repellent',concentrations:[{label:'4-6 drops in diffuser',mgPerUnit:4,unitML:1}]},
        },
        ...
        warnings:{child:'Highly skin-sensitizing — Tisserand & Young recommend strict dermal max of 0.7%. Not under 6. Common in natural bug-repellent products but use sparingly on skin.',adult:'Strong skin sensitizer — always dilute heavily and patch-test first. Avoid in pregnancy. Tisserand & Young dermal max 0.7%. Effective natural mosquito repellent (citronellal/geranial content).'},
      },
      ...
      sandalwoodOil: {
        ...
        formats:{
          liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1 drop or 1% of essential oil per tsp of carrier oil — kids 6+',mgPerUnit:1,unitML:5},{label:'2 drops or 2% of essential oil per tsp of carrier oil — adults',mgPerUnit:2,unitML:5}]},
          liquid2:{label:'Diffusion',concentrations:[{label:'2-4 drops in diffuser (rich grounding scent)',mgPerUnit:2,unitML:1}]},
        },
        source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. Churchill Livingstone 2014 · Worwood VA: Complete Book of Essential Oils 2nd ed. 2016.',
        warnings:{child:'Dilute properly. Not for children under 6.',adult:'Sustainability note: Indian sandalwood (Santalum album) is CITES-protected and overharvested — buy only certified sustainable Indian, OR choose Australian sandalwood (Santalum spicatum) which is a sustainable alternative with similar therapeutic properties. Always dilute. Generally very well tolerated topically. Premium specialty oil — expect high prices for authentic Australian or certified Indian.'},
      },
