...
export const MEDS = {
    ...
    dextromethorphan: {
      ...
      pharmClasses:['serotonergic','cns_depressant'],
   ...
   // ═══════════════════════════════════════════════════
    ...
    albuterol: {
      ...
      amoxicillin: {
        ...
        pharmClasses:['antibiotic_penicillin'],
      ...
      azithromycin: {
        ...
        pharmClasses:['antibiotic_macrolide','qt_prolonging','cyp3a4_inhibitor'],
      ...
      birthControlCombined: {
        name:'Birth Control Pill (Combined Estrogen/Progestin)', brand:'Various (Sprintec, Ortho Tri-Cyclen, Yaz, etc.)', category:'prescription',
        pharmClasses:['hormonal_contraceptive','estrogen_containing'],
        tags:['interaction_reference'],
        requiresIndividualization:true,
        standardRange:'1 tablet daily, same time each day, as prescribed',
        flatDose:{child:{},adult:0},
        maxSingleDose:{child:0,adult:0}, maxDailyDose:{child:0,adult:0},
        intervalHours:24, maxDosesPerDay:1, minAge:{years:15},
        formats:{
          tablet:{label:'Reference only — not dosed here',concentrations:[{label:'See pair-wise interactions',mgPerUnit:0}]},
        },
        source:'FDA Combined Hormonal Contraceptive Labeling · ACOG Guidance · Lexi-Interact 2024.',
        warnings:{child:'Birth control pill prescribing requires clinician evaluation. Listed here for interaction reference.',adult:'Listed here for medication interaction reference. Combined oral contraceptives contain estrogen and progestin. Many medications and supplements can reduce effectiveness (rifampin, certain antibiotics, St. John\'s Wort, some seizure medications). Other interactions raise blood clot risk (smoking, some other estrogen sources). Always tell prescribers and pharmacists you take combined birth control before starting any new medication.'},
      },
  
      bupropion: {
        name:'Bupropion', brand:'Wellbutrin / Zyban', category:'prescription',
        pharmClasses:['atypical_antidepressant','seizure_threshold_lowering','cyp2d6_inhibitor'],
        tags:['anxiety'],
      ...
      cephalexin: {
        ...
        pharmClasses:['antibiotic_cephalosporin'],
      ...
      ciprofloxacin: {
        ...
        pharmClasses:['antibiotic_fluoroquinolone','absorption_sensitive','qt_prolonging'],
        tags:['ear_pain'],
      ...
      doxycycline: {
        ...
        pharmClasses:['antibiotic_tetracycline','absorption_sensitive','photosensitizing'],
      ...
      empagliflozin: {
        ...
        pharmClasses:['diabetes_med','sglt2_inhibitor','diuretic'],
        tags:[],
      ...
      metformin: {
        ...
        pharmClasses:['diabetes_med','biguanide'],
        tags:[],
      ...
      semaglutide: {
        ...
        pharmClasses:['diabetes_med','glp1_agonist'],
        tags:[],
  ...
  // ═══════════════════════════════════════════════════
    ...
    alcohol: {
        name:'Alcohol (Beer / Wine / Spirits)', brand:'Various', category:'home',
        pharmClasses:['cns_depressant','hepatotoxic','diuretic'],
        tags:['interaction_reference'],
        flatDose:{child:{},adult:0},
        maxSingleDose:{child:0,adult:0}, maxDailyDose:{child:0,adult:0},
        intervalHours:24, maxDosesPerDay:0, minAge:{years:21},
        formats:{
          liquid:{label:'Reference only — not dosed here',concentrations:[{label:'See pair-wise interactions',mgPerUnit:0,unitML:0}]},
        },
        source:'NIAAA — Alcohol\'s Effects on the Body (2024) · Lexi-Interact 2024.',
        warnings:{child:'Alcohol is not appropriate for anyone under 21.',adult:'Listed here for medication interaction reference only. Many medications interact with alcohol — combining can cause excessive sedation, liver damage, GI bleeding, low blood sugar, or other serious effects. Always check with a pharmacist or prescriber if you drink alcohol while on any medication.'},
      },
      caffeine: {
        name:'Caffeine (Coffee / Tea / Energy Drinks)', brand:'Various', category:'home',
        pharmClasses:['sympathomimetic','bp_raiser','cns_stimulant','diuretic'],
        tags:['interaction_reference'],
        flatDose:{child:{},adult:0},
        maxSingleDose:{child:0,adult:0}, maxDailyDose:{child:0,adult:0},
        intervalHours:24, maxDosesPerDay:0, minAge:{years:12},
        formats:{
          liquid:{label:'Reference only — not dosed here',concentrations:[{label:'See pair-wise interactions',mgPerUnit:0,unitML:0}]},
        },
        source:'NIH NCCIH — Caffeine (2024) · Lexi-Interact 2024 · ACOG Caffeine in Pregnancy 2023.',
        warnings:{child:'Caffeine is not recommended for children under 12. Listed here for medication interaction reference only.',adult:'Listed here for medication interaction reference only. Caffeine interacts with many medications — combining can amplify cardiovascular effects, alter drug metabolism, or counteract calming medications. Adult intake should generally stay under 400 mg/day (about 4 cups of coffee). Pregnancy: under 200 mg/day. Always check with a pharmacist if you consume significant caffeine while on any medication.'},
      },
      grapefruit: {
        name:'Grapefruit (Whole Fruit / Juice)', brand:'Various', category:'home',
        pharmClasses:['cyp3a4_inhibitor'],
        tags:['interaction_reference'],
        flatDose:{child:{},adult:0},
        maxSingleDose:{child:0,adult:0}, maxDailyDose:{child:0,adult:0},
        intervalHours:24, maxDosesPerDay:0, minAge:{years:0},
        formats:{
          liquid:{label:'Reference only — not dosed here',concentrations:[{label:'See pair-wise interactions',mgPerUnit:0,unitML:0}]},
        },
        source:'FDA Drug Interaction Database · Bailey DG et al. CMAJ 2013 · Lexi-Interact 2024.',
        warnings:{child:'Grapefruit itself is safe for kids; this entry is for medication interaction reference only.',adult:'Grapefruit and grapefruit juice contain furanocoumarins that inhibit CYP3A4, the liver enzyme that metabolizes about 50% of all medications. Even a single 8 oz glass of grapefruit juice can raise blood levels of certain drugs 2–3 fold, with the effect lasting 24–72 hours. Affects statins (atorvastatin, simvastatin, lovastatin), some blood pressure medications, apixaban, immunosuppressants (cyclosporine, tacrolimus), and many others. Always check with a pharmacist about grapefruit when starting any new medication.'},
      },
      activatedCharcoal: {
