...
export const TOTAL_SELECTION_CAP = 10;
  ...
  export const MEDS = {
    ...
    bergamotOil: {
      ...
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — children 6+',mgPerUnit:1,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion',concentrations:[{label:'3-5 drops in diffuser (30 min)',mgPerUnit:3,unitML:1}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. Churchill Livingstone 2014.',
      warnings:{child:'Use FCF (furanocoumarin-free) bergamot to avoid photosensitivity. Dilute properly.',adult:'Regular bergamot is strongly phototoxic — do not apply before sun exposure. Use FCF bergamot for skin use. Always dilute.'},
    },
    ...
    cedarwoodOil: {
      ...
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — children 2+',mgPerUnit:1,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion',concentrations:[{label:'3-5 drops in diffuser (30 min)',mgPerUnit:3,unitML:1}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. Churchill Livingstone 2014.',
      warnings:{child:'Dilute properly. Do not ingest. Avoid near face of infants under 2.',adult:'Always dilute before skin application. Do not ingest.'},
    },
    ...
    chamomileRomanOil: {
        ...
        intervalHours:6, maxDosesPerDay:3, minAge:{years:2},
        formats:{
          liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'0.5% dilution — children 2-6',mgPerUnit:0.5,unitML:5},{label:'1% dilution — children 6+',mgPerUnit:1,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
          liquid2:{label:'Diffusion',concentrations:[{label:'2-4 drops in diffuser (30 min)',mgPerUnit:2,unitML:1}]},
        },
        ...
        warnings:{child:'One of the gentlest essential oils — generally safe for children 2+ at proper dilution. Avoid with ragweed/daisy allergy. Distinct from German chamomile (Matricaria recutita).',adult:'Generally very well tolerated. Avoid if allergic to ragweed, daisies, or chrysanthemums. Use Roman (Chamaemelum nobile) for skin/calming; German chamomile is darker blue and better for inflammation.'},
      },
    ...
    clarySageOil: {
      ...
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion',concentrations:[{label:'3-5 drops in diffuser',mgPerUnit:3,unitML:1}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014 · Ou MC et al. J Obstet Gynaecol Res 2012.',
      warnings:{child:'Not under 12. Not during pregnancy.',adult:'Do not use during pregnancy. Avoid with estrogen-sensitive conditions. May cause drowsiness.'},
    },
    ...
    cloveOil: {
      ...
      intervalHours:8, maxDosesPerDay:3, minAge:{years:2},
      formats:{
        liquid:{label:'Topical on gums (heavily diluted)',concentrations:[{label:'0.5% dilution — children 2+ (1 drop per 4 tsp carrier)',mgPerUnit:0.5,unitML:20},{label:'1% dilution — adults',mgPerUnit:1,unitML:10}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014 · American Dental Association position on eugenol.',
      warnings:{child:'Must be heavily diluted. Apply sparingly to gums only. Not for infants under 2.',adult:'Highly potent — always dilute heavily. Undiluted clove oil can burn tissue. Do not ingest.'},
    },
    ...
    eucalyptusOil: {
      ...
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — age 10+',mgPerUnit:1,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion / Steam inhalation',concentrations:[{label:'3-5 drops in diffuser',mgPerUnit:3,unitML:1},{label:'2-3 drops in steam bowl',mgPerUnit:2,unitML:1}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014 · American Association of Poison Control Centers.',
      warnings:{child:'NEVER use on or near children under 10 — can cause serious breathing problems and seizures.',adult:'Always dilute before skin application. Do not ingest.'},
    },
    ...
    frankincenseOil: {
      ...
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Dilute properly. Not well studied under 6.',adult:'Always dilute before skin application. Do not ingest. May interact with blood-thinning medications.'},
    },
    ...
    geraniumOil: {
        ...
        warnings:{child:'Dilute properly. Not under 6 without practitioner guidance. Avoid near face of young children.',adult:'Always dilute before skin application. Avoid in pregnancy (especially first trimester) — may stimulate uterine activity. May affect blood sugar — caution with diabetes medications.'},
      },
    ...
    gingerOil: {
      ...
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — children 6+',mgPerUnit:1,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion / Inhalation',concentrations:[{label:'3-4 drops in diffuser',mgPerUnit:3,unitML:1}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Dilute properly. Not for children under 6.',adult:'May cause mild skin sensitization. Always dilute. Patch test first.'},
    },
    ...
    lavenderOil: {
      ...
      intervalHours:6, maxDosesPerDay:3, minAge:{years:2},
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'0.5-1% dilution — children 2-6',mgPerUnit:0.5,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion',concentrations:[{label:'3-5 drops in diffuser (30 min sessions)',mgPerUnit:3,unitML:1}]},
      },
      source:'NIH NCCIH — Lavender (2024) · Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Dilute properly for age. Avoid near face of infants. Do not ingest.',adult:'Generally safe for topical and aromatherapy use. Always dilute before skin application.'},
    },
    ...
    lemonOil: {
      ...
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — children 6+',mgPerUnit:1,unitML:5},{label:'2% dilution — adults',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion / Inhalation',concentrations:[{label:'3-5 drops in diffuser',mgPerUnit:3,unitML:1}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Phototoxic — do not apply before sun exposure. Dilute properly.',adult:'Phototoxic — avoid skin application before sun exposure. Use steam-distilled lemon oil (less phototoxic than cold-pressed). Always dilute.'},
    },
    ...
    marjoramOil: {
        ...
        source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. Churchill Livingstone 2014 · Worwood VA: Complete Book of Essential Oils 2nd ed. 2016.',
        warnings:{child:'Sweet marjoram (Origanum majorana) — NOT oregano oil. Dilute properly. Not under 6 without practitioner guidance.',adult:'Confused often with oregano oil — they are different. Sweet marjoram is gentler. Always dilute. Avoid in pregnancy. May cause drowsiness at high doses — do not drive after heavy use.'},
      },
    ...
    oreganoOil: {
      ...
      intervalHours:8, maxDosesPerDay:3, minAge:{years:12},
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — adults only',mgPerUnit:1,unitML:10}]},
        gelcap:{label:'Enteric-coated softgel',concentrations:[{label:'50 mg softgel (10:1 extract)',mgPerUnit:50},{label:'150 mg softgel',mgPerUnit:150}]},
      },
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014 · Preuss HG et al. Phytother Res 2005.',
      warnings:{child:'Not under 12. Very potent — can cause chemical burns if undiluted.',adult:'Highly potent — always dilute heavily. Oral oil of oregano can interact with blood thinners and lithium.'},
    },
    ...
    peppermintOil: {
      ...
      intervalHours:6, maxDosesPerDay:3, minAge:{years:6},
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — children 6+ (1 drop per tsp carrier)',mgPerUnit:1,unitML:5},{label:'2% dilution — adults (2 drops per tsp carrier)',mgPerUnit:2,unitML:5}]},
        liquid2:{label:'Diffusion',concentrations:[{label:'3-5 drops in diffuser (30 min sessions)',mgPerUnit:3,unitML:1}]},
      },
      source:'NIH NCCIH — Peppermint Oil (2024) · Gobel H et al. Cephalalgia 1994 · Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Never apply near face or mouth of children under 6. Do not use on infants. Dilute to 1% for children 6+.',adult:'Always dilute before skin application. Avoid contact with eyes. Do not ingest without medical supervision.'},
    },
    ...
    rosemaryOil: {
      ...
      source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Not for children under 6. Avoid near face.',adult:'Avoid with epilepsy or high blood pressure. Do not ingest. Always dilute.'},
    },
    ...
    sweetOrangeOil: {
        ...
        source:'Tisserand R, Young R: Essential Oil Safety, 2nd ed. Churchill Livingstone 2014 · Worwood VA: Complete Book of Essential Oils 2nd ed. 2016.',
        warnings:{child:'Unlike most citrus oils, sweet orange (Citrus sinensis) is NOT phototoxic — safer for daytime use. Gentle enough for children 2+ properly diluted. Do not confuse with bitter orange (Citrus aurantium) which IS phototoxic.',adult:'Sweet orange is one of the few citrus oils that is NOT phototoxic — safe to apply before sun exposure. Always dilute before skin application. Shelf life shorter than most oils (~1 year) — oxidized citrus oils can cause skin sensitization.'},
      },
    ...
    teaTreeOil: {
      ...
      intervalHours:8, maxDosesPerDay:3, minAge:{years:6},
      formats:{
        liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'1% dilution — children 6+',mgPerUnit:1,unitML:5},{label:'2-5% dilution — adults',mgPerUnit:2,unitML:5}]},
      },
      source:'NIH NCCIH — Tea Tree Oil (2024) · Tisserand R, Young R: Essential Oil Safety, 2nd ed. 2014.',
      warnings:{child:'Never ingest — toxic if swallowed. Not for children under 6. Keep out of reach of children.',adult:'Never ingest — toxic if swallowed. Always dilute before skin application.'},
    },
    ...
    ylangYlangOil: {
        ...
        intervalHours:8, maxDosesPerDay:3, minAge:{years:12},
        formats:{
          liquid:{label:'Topical (diluted in carrier oil)',concentrations:[{label:'0.8% dilution — adults (Tisserand max)',mgPerUnit:0.8,unitML:5}]},
          liquid2:{label:'Diffusion',concentrations:[{label:'2-3 drops in diffuser (30 min) — strong scent',mgPerUnit:2,unitML:1}]},
        },
        ...
        warnings:{child:'Not under 12 — moderate skin sensitization risk. Strong scent can cause headaches/nausea in children even via diffusion.',adult:'Tisserand & Young set a strict dermal maximum of 0.8% due to skin sensitization risk — significantly lower than most oils. Strong scent — start with 1-2 diffuser drops. May cause headaches or nausea at high concentrations. Avoid in pregnancy.'},
      },
