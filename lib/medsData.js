...
export const CATEGORIES = {
    otc:            { label: 'OTC Medications',        icon: '💊' },
    supplements:    { label: 'Vitamins & Supplements',  icon: '🧴' },
  ...
  export const MEDS = {
    ...
    ibuprofen: {
      ...
      formats:{
        liquid:{label:'Liquid suspension',concentrations:[{label:"100 mg/5 mL (Children's)",mgPerUnit:100,unitML:5},{label:'50 mg/1.25 mL (Infant drops)',mgPerUnit:50,unitML:1.25}]},
        chewable:{label:'Chewable tablet',concentrations:[{label:'100 mg tablet',mgPerUnit:100}]},
        tablet:{label:'Standard tablet',concentrations:[{label:'200 mg OTC standard',mgPerUnit:200},{label:'400 mg Rx strength',mgPerUnit:400}]},
        gelcap:{label:'Liquid-filled gel cap',concentrations:[{label:'200 mg gel cap',mgPerUnit:200},{label:'400 mg gel cap',mgPerUnit:400}]},
      },
