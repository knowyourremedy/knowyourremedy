...
| Other sugar alcohols | sorbitol, maltitol, mannitol, sorbitol 70% solution USP | GI effects at volume. Sorbitol 70% solution USP maps here (Sept 25, 2026). Same Limited lock. Not Caution. |
...
| Coconut oil alone in gummies/chews — **LOCKED (Sept 14, 2026 housekeeping)** | NOT the seed/industrial-oil High rule. Already practice on coconut-only gummy/chew rows; this table says it. Unlabeled “vegetable oil” / palm / soybean / canola / sunflower in gummies stays High. Fractionated Coconut Oil / Coconut Oil, Fractionated in a GUMMY sit on this same coconut-in-gummy exception (Sept 16, 2026). Tap both sides. |
...
| Flavor / banana flavor / flavadew coolmint — LOCKED (Sept 24, 2026) | flavor, flavors, orange flavor, peppermint flavor, assorted flavors, banana flavor, flavadew coolmint | Exact tokens. Caution. Distinct from Limited natural flavors. Do not flip that row. Flavors maps here (Sept 25, 2026). Orange flavor, peppermint flavor, and assorted flavors map here (Sept 25, 2026). Natural apple flavor and artificial blueberry flavor map here (Sept 25, 2026). Alias the family. Not a new grade. | Standard alternatives rule. Not Avoid. |
...
| Purple carrot concentrate — LOCKED (Sept 25, 2026) | purple carrot concentrate | Exact token. Caution. Purple carrot for color stays Cleared. Do not flip that named-color row. | Standard alternatives rule. Not Avoid. |
