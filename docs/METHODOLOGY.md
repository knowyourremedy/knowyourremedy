...
| Glycerin / vegetable glycerin / organic glycerin — **LOCKED (Sept 14, 2026 housekeeping)** | Standard humectant / capsule-softgel plasticizer. Not a flag. Also written glycerine (Sept 16, 2026) and glycerol (Sept 22, 2026). Same Cleared row. Distinct from Glycerol Monostearate / GMS. |
...
| Mixed tocopherols, ascorbyl palmitate (as antioxidants) — **LOCKED (v1.6)** | Long-established GRAS vitamin-E-derived antioxidants; the natural BHA/BHT alternative. No safety flags found. D-Alpha-Tocopherol as inactive sits on this same mixed-tocopherols row (Sept 16, 2026). Distinct from Caution tocopheryl acetate. DL-alpha tocopheryl acetate is its own Cleared token (Sept 23, 2026). Do not alias bare tocopheryl acetate onto either Cleared row. |
...
| lanolin alcohol — LOCKED (Sept 16, 2026) | Exact token. Same Caution as lanolin / wool-alcohol family. Distinct from Cleared ceresin. Do not Clear. | Standard alternatives rule. Prefer a lanolin-free Good option in the same category if one exists. Do not raise to Avoid. |
