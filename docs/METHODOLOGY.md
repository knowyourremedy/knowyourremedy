...
| Oat Fiber — LOCKED (Sept 16, 2026) | Exact token. Fiber; inulin / oat neighborhood. Cleared. Distinct from Oat in oral syrup (already Cleared food soother). |
...
| gum arabic — LOCKED (Sept 16, 2026 restamp) | Exact token. Same as acacia / organic acacia gum. Cleared. |
