...
**Changed Sept 25, 2026 (FD-C dye aliases — founder stamp):** FD-C, D-C, “no.”, and “no ” map to the existing FD&C / D&C dye Avoid locks. Not a new grade. Mica based pearlescent pigment maps to mica-based pearlescent pigment Caution. Same token.

**Changed Sept 25, 2026 (TIME-Cap refuse maps — founder stamp):** Eudragit → methacrylic enteric Caution. Methacrylic acid and ethyl acrylate copolymer, without the word dispersion, → the same copolymer Caution. Polyethylene glycol (peg) 8000 / polyethylene glycol 6000 / PEG 6000 / PEG 8000 → PEG Caution. Colloidal silicone dioxide → silica / SiO2 Caution. Mono and diglyceride of caprylic/capric acid → mono- and diglycerides Caution. Not Cleared medium-chain glycerides. Calcium sulfate / calcium sulfate anhydrous / Anhydrous Calcium Sulfate → calcium sulfate Cleared. Acadia → acacia / gum arabic. Same existing Cleared lock. Not Caution. Polyvinyl Acetate Phthalates → PVAP Caution.

**Changed Sept 25, 2026 (HealthA2Z gummy stamps — founder stamp):** Nautural Orange Flavor → orange flavor Caution. Natural peach / strawberry / raspberry / watermelon / blackberry flavor → flavor Caution. Paprika extract (natural color) → paprika extract Caution. Founder restamp from the Cleared color-only lock. Purple carrot juice / purple carrot juice concentrate → carrot color Caution. Purple Carrot (Color) exact string stays Cleared. Carnuaba wax → carnauba Caution. Carnauba wax in vegetable oil splits: carnauba Caution, and the gummy vegetable-oil half Avoid. Maltitol solution → maltitol Caution. Distinct from Limited maltitol powder. Isomalt → Caution. Founder restamp from Limited. Coconut oil in a gummy → Avoid, same as gummy vegetable oil. Fractionated coconut oil in a gummy stays the prior exception.

**Changed Sept 25, 2026 (HealthA2Z exact leftovers — founder stamp):** sodium citrate (dihydrate) → citrate-salt Cleared. polyethylene glycol-400 USP → PEG Caution. silicified microcrystalline cellulose → MCC Cleared. sugar spheres [...] and sugar spheres → bare sugar Caution. Bare beta-carotene → beta-carotene as color Caution. Same locks. Not new grades.

**Changed Sept 25, 2026 (HealthA2Z alias families 2 — founder stamp):** Dibasic / dicalcium phosphate dihydrate → calcium phosphate Cleared. Microcrystallinecellulose and silicified MCC → MCC Cleared. D&C Yellow 10 / yellow 5 / blue 1 / FD&C blue #1 brilliant blue lake → those synthetic dyes Avoid. Iron oxide ochre → iron oxide as color Caution. Bare starch as filler → Cleared simple-starch filler. Unspecified starch stays Caution. Sodium citrate dihydrate → citrate-salt Cleared. Edetate disodium dihydrate = EDTA Caution. Distinct from Cleared disodium EDTA trace. Glycerin USP → glycerin Cleared. PEG-400 USP → PEG Caution. Povidone USP → povidone Cleared. Purified water USP → purified water Cleared. Sorbitol 70% solution USP → Limited oral sorbitol. Methacrylic acid and ethyl acrylate copolymer dispersion → existing methacrylic acid copolymer Caution. Sugar spheres → bare sugar Caution. Mono- and Di-Glycerides → existing mono- and diglycerides Caution. Natural apple flavor / artificial blueberry flavor → flavor Caution. Unfiltered liquid ACV / purple carrot concentrate / malt syrup = Caution. Purple carrot for color stays Cleared. Barley malt syrup stays Limited. Citrus pectin → pectin Cleared. Sodium hexametophosphate → hexametaphosphate Caution. Beta-carotene as color stays Caution.

**Changed Sept 25, 2026 (HealthA2Z alias families — founder stamp):** Alias the family, not one spelling. Iron oxide black / black iron oxide / ironoxide yellow / red iron oxide → iron oxide as color Caution. FD&C yellow # 6 aluminum lake / FD&Cyellow #6 / Yellow 6 lake → Yellow 6 / synthetic dyes Avoid. Orange flavor / peppermint flavor / assorted flavors / flavors → flavor Caution. Acacia gum → acacia / gum arabic. Same existing Cleared lock. Not a new grade. Do not flip that Cleared row to Caution. Saccharin sodium → sodium saccharin Caution. Sorbitol sorbitan → sorbitol sorbitan solution Caution. Black edible ink → pharmaceutical ink Caution. Dual-panel day/night stays no-row. Omeprazole coating: map only exact locked polymer names. Leftover unknown coating strings stay refuse.
...
**Changed Sept 23, 2026 (NatureWise last refuse — founder stamp):** Map — stevia leaf extract → existing stevia extract Caution (not whole-leaf / crude stevia; not Reb A / Reb M). New exact — bare turmeric as OI Caution (curcumin-as-color stays its own Cleared row; oleoresin turmeric stays its own Caution row). Behenoyl polyoxyl-8 glycerides Caution (PEG-style glyceride; not High).

**Changed Sept 23, 2026 (NatureWise leftover fruit / foam — founder stamp):** Cleared — cranberry fruit; organic raspberry; organic raspberry powder. Blueberry juice concentrate: Cleared as color; Caution as sweetener. Caution — non-silicone foam control agent (unspecified processing aid). Distinct from the cranberry / raspberry / blueberry juice-or-fruit-powder color-vs-sweetener split. Do not flip that split.

**Changed Sept 23, 2026 (NatureWise batch82 clean tokens — founder stamp; use existing §5 where named):** Map — bamboo extract + bambusa vulgaris shoot → organic bamboo extract Caution; modified tapioca starchgel / cassava root → cassava dextrin / starch Caution (Limited modified starch / modified tapioca starch stays Limited). Corn oil keeps the oil form split (gummy Avoid; fill Cleared). No grade change on that split. Caution — rice bran wax; organic rice bran (unspecified bran); ethyl vanillin; ethyl acrylate copolymer; methacrylic acid; ConcenTrace mineral complex; grapefruit extract; organic aloe vera / powder as OI; bare carrot unless clearly color. Cleared — triethyl citrate (already locked Sept 15; do not re-add); potassium acetate. Cranberry / raspberry / blueberry juice or fruit powder: Cleared as named fruit color; Caution as unspecified sweetener. NatureWise no_OI 28 stays hunt list. OUT 15 stays dead.

**Changed Sept 23, 2026 (annatto suspension in sunflower oil — founder stamp):** Split the clause. Not a new token. Annatto half = existing annatto Caution. Sunflower-oil half = existing non-gummy / softgel fill Cleared. Softgel fill stays Cleared. Grade follows annatto. Gummy sunflower oil stays High.

**Changed Sept 22, 2026 (batch79 refuse strings — founder stamp; use existing §5 where named):** Map — annatto extract (for color) → annatto Caution; glycerol → glycerin Cleared; water / bare water → purified water Cleared; organic gum arabic → gum arabic Cleared; organic sunflower lecithin → lecithin Cleared; sunflower oil non-gummy → named fill Cleared (gummy sunflower stays High). New exact — iron oxide as color Caution; trisodium citrate Cleared; lemon juice concentrate Caution as sweetener / Cleared as color; pea starch Caution (was Limited; founder restamp); organic oat fiber Caution (Oat Fiber stays Cleared).
...
**Changed Sept 16, 2026 (Amazon house leftover exact tokens):** Cleared — Lo Han Fruit Concentrate (monk fruit / luo han sibling); ceresin (wax / petrolatum neighborhood). Limited — unlabeled modified cellulose (unspecified modified cellulose/starch neighborhood; named MCC / HPMC / ethylcellulose / methylcellulose stay Cleared). Caution — edible ink (unspecified); sodium pyruvate.

**Changed Sept 16, 2026 (Thrive refused-unlock exact tokens):** Cleared (NOT gummy seed-oil High) — Psyllium Husk (fiber; inulin neighborhood); Oat Fiber; Medium Chain Triglycerides (derived from palm kernel oil) as capsule/liquid fill (named MCT; tap vs unlabeled MCT and vs gummy High); Organic Myceliated Oats (food-state oat/ferment; if it is the mushroom active it is not an Other Ingredient); Calcium Hydroxide / Magnesium Hydroxide as pH adjuster (same job as NaOH); Vegetable Juice Extract (Color) / Furit And Vegetable Juice Extract (Color) (alias of named vegetable-juice-as-color). Caution — Vegetable-Based Tablet Coating (unnamed coat; named wax/GMS stays Cleared); seaweed extract (unspecified; named plant-color / named kelp is not this row); Ginger Oil (EO / scent line); Irish Moss as inactive (unspecified seaweed/extract, not a named-color pass); Evaporated Sea Water as inactive (vague mineral-water line); Non-GMO corn zein (beadlets) (coating polymer, not pea-protein isolate); oral hydrated silica (same nanoparticle Caution cap as silicon dioxide; tap vs topical hydrated silica). Unlabeled MCT / MCT with no plant named stays Limited (already locked; restamped; tap vs named-MCT Cleared — not flipped).
...
**Changed Sept 14, 2026 (Hyland’s locks):** Glycyrrhiza extract / licorice extract (oral inactive) = Cleared named botanical. Do not Caution the product on licorice alone. Tap + honest-note line (exact): “Licorice extract. Very high intakes of glycyrrhizin can affect blood pressure and potassium — that is not this syrup dose.” Wood rosin / colophony (topical) = Caution (contact-allergy pattern), not Avoid. FDA is one source, not a veto.

**Changed Sept 15, 2026 (Hyland’s founder-carton closeout):** Lavender oil (topical) = Caution, fragrance-style (same posture as fragrance / parfum). Wintergreen extract (topical inactive) = Caution. Vegetable oil in a cream / topical is NOT the gummy seed-oil High rule — tap both sides. Rebaudioside M = Cleared high-purity steviol glycoside (named sibling of the stevia lock). Ethyl alcohol Limited, stearyl / cetearyl Cleared, petrolatum Cleared, sodium stearoyl glutamate Cleared, soluble tapioca fiber Cleared, lactic / malic Cleared — already locked; founder cartons now writable.
...
- **After a lock, it goes in this table the same day.** Do not leave a locked call as chat-only.
...
| Synthetic dyes | FD&C/D&C colors, FD-C, D-C, "no.", "no ", aluminum lakes, D&C red #27 aluminum lake, D&C red #30 aluminum lake, FD&C yellow # 6 aluminum lake, FD&Cyellow #6, Yellow 6 lake, D&C Yellow 10, yellow 5, blue 1, FD&C blue #1 brilliant blue lake | FDA revoked Red No. 3 (2025). Red 40, Yellow 5/6, Blue 1/2, Green 3 carry EU hyperactivity warnings (Southampton study). Applies equally to lake (insoluble tablet) forms. D&C red #27 / #30 aluminum lake sit on this same High family — exact strings added. FD&C yellow # 6 aluminum lake, FD&Cyellow #6, and Yellow 6 lake sit on this same Yellow 6 Avoid family (Sept 25, 2026). D&C Yellow 10, yellow 5, blue 1, and FD&C blue #1 brilliant blue lake sit on this same Avoid family (Sept 25, 2026). FD-C, D-C, “no.”, and “no ” are spellings of these same FD&C / D&C locks (Sept 25, 2026). Not a new grade. |
...
| Seed/industrial oils (gummies / lozenges) | soybean, canola, palm, safflower, sunflower, "vegetable oil" | Clean-standard exclusion for gummy formulations. Lozenges / cough drops with soybean oil sit on this same High row (Sept 16, 2026 founder lock). Gummy print of safflower / sunflower / palm stays High. Sunflower oil as a non-gummy fill is named-fill Cleared (Sept 22, 2026) — tap both sides; gummy sunflower stays High. Hydrogenated vegetable oil as a gummy fat blend stays Avoid (Sept 22, 2026 restamp — no grade change). Corn oil keeps this same form split (Sept 23, 2026): gummy Avoid; fill Cleared. Tap both sides. No new oil class. Coconut oil in a gummy is Avoid, same as gummy vegetable oil (Sept 25, 2026 founder restamp). Fractionated coconut oil in a gummy stays the prior exception. Tablet / capsule / softgel / drop fill of Organic Palm Oil, High Oleic Safflower Oil, safflower oil as softgel fill, Medium Chain Glycerides, or named Medium Chain Triglycerides (derived from palm kernel oil) is NOT this High rule (see Cleared; tap both sides). Liquid-drop oil carriers and cream / topical vegetable oil use the same non-gummy rule as capsule/softgel fill; tap text required. |
...
| Caramel color, UNDISCLOSED CLASS — **LOCKED (v1.6)** | "caramel color"/"caramel colour," no class stated, plain caramel powder | IARC 2B (4-MEI byproduct), Prop 65 listed, EU exposure limit. Undisclosed class treated as Class III/IV — burden on the label to prove otherwise. Exact restamp Sept 16, 2026 — no grade change: caramel color undisclosed class stays Avoid (existing 3-way split). Plain caramel powder sits on this same Avoid row (Sept 24, 2026). Not caramel sugar syrup. |
...
|---|---|---|
| Silicon dioxide | Silica, SiO2, E551, oral hydrated silica, Silica (oral), colloidal anhydrous silica, colloidal silicone dioxide | EFSA 2018: no confirmed harm, but open nanoparticle data-gap review still unresolved. Distinct from crystalline silica (unrelated inhalation hazard). Oral hydrated silica and Silica (oral) sit on this same nanoparticle Caution cap (Sept 16, 2026). Colloidal anhydrous silica maps here (Sept 24, 2026). Colloidal silicone dioxide maps here (Sept 25, 2026). Same SiO2 lock. Not a silicone polymer. Not a new grade. Tap vs topical hydrated silica (separate Caution row — not this oral cap). |
...
| PEGs | polyethylene glycol 400/3350, polyethyleneglycol, polyethylene glylcol, macrogol, PEG-400 USP, polyethylene glycol-400 USP, polyethylene glycol (peg) 8000, polyethylene glycol 6000, PEG 6000, PEG 8000, PEG-stearate, pegoxol-7 stearate, lauroyl macrogolglycerides | Ethylene-oxide/1,4-dioxane contamination risk. PEG-stearate, pegoxol-7 stearate, and lauroyl macrogolglycerides sit on this same Moderate/Caution family row. Polyethyleneglycol maps here (Sept 24, 2026). Macrogol and polyethylene glylcol map here (Sept 25, 2026). PEG-400 USP maps here (Sept 25, 2026). Polyethylene glycol-400 USP is the same lock. PEG 6000 and PEG 8000 map here (Sept 25, 2026). Not a new grade. |
...
| Other sugar alcohols | sorbitol, maltitol, mannitol, sorbitol 70% solution USP | GI effects at volume. Sorbitol 70% solution USP maps here (Sept 25, 2026). Same Limited lock. Maltitol powder stays Limited. Maltitol solution is Caution (Sept 25, 2026). Not this row. |
| isomalt — LOCKED (Sept 15, 2026) | isomalt | Founder restamp Sept 25, 2026: Caution. Not Limited. See the Caution row. |
| Synthetic preservatives | sodium benzoate, potassium sorbate | Generally low risk; benzoate + vitamin C can form trace benzene. |
| "Natural flavors" | natural flavoring, natural and artificial flavors | Undisclosed mixtures — opacity, not a known hazard. natural and artificial flavors sits on this same Limited row (Sept 16, 2026). Already Limited — not flipped to Caution. |
| natural and artificial flavors — LOCKED (Sept 16, 2026) | natural and artificial flavors | Exact token. Same Limited natural-flavors opacity row. Not Caution. |
...
| Unlabeled MCT — LOCKED | MCT with no coconut (or other) source named, MCT with no plant named | Opacity. Not Avoid. Already locked Limited — restamped Sept 16, 2026, not flipped. Tap both: named Medium Chain Triglycerides (derived from palm kernel oil) / MCT oil labeled coconut are Cleared fill; this unlabeled string is not that Cleared row. |
...
| Modified starch — LOCKED (Sept 15, 2026) | modified food starch, Organic Rice Starch, Non-GMO Maize Starch | Unspecified modified-starch neighborhood. Organic Rice Starch and Non-GMO Maize Starch sit on this same Limited row (Sept 16, 2026). Distinct from Cleared named corn starch / potato starch / pregelatinized starch. Distinct from Caution unspecified starch and from Caution pea starch (Sept 22, 2026 founder restamp — pea starch is no longer this Limited row). Do not flip this Limited row. |
...
| fruit puree / juice concentrate as gummy base — LOCKED (Sept 15, 2026) | fruit puree, juice concentrate (gummy base), Almond Butter (gummy pieces), Rowanberry (gummy pieces) | Limited. Gummy base / gummy pieces, not the Cleared named juice-as-color row. Almond Butter / Rowanberry as gummy pieces sit here (Sept 16, 2026). Distinct from lemon juice concentrate (Caution as sweetener / Cleared as color; Sept 22, 2026). Do not flip this Limited gummy-base row. |
...
| Microcrystalline cellulose, croscarmellose sodium, cellulose gum, powdered cellulose, capsule cellulose | Standard disintegrants / cellulose-family fillers. EFSA 2017: no carcinogenicity, no ADI needed. Cellulose gum, powdered cellulose, and capsule cellulose are Cleared-by-class with MCC. Microcrystalline Cellulosse is a MCC typo alias (Sept 16, 2026) — both strings written; honest note “label typo.” Microcrystallinecellulose and silicified MCC map here (Sept 25, 2026). Silicified microcrystalline cellulose is the same MCC lock. An MCC + CMC combo maps to these two Cleared locks (Sept 24, 2026). Sodium carboxy methyl cellulose maps to cellulose gum / CMC (Sept 24, 2026). Not a new grade. |
...
| Stearyl alcohol / cetearyl alcohol (topical) — LOCKED | Fatty alcohols. Cetyl alcohol and cetostearyl alcohol sit on this same Cleared fatty-alcohol cream base (Sept 24, 2026). Not a new grade. |
...
| triethyl citrate — LOCKED (Sept 15, 2026) | Exact INCI. Cleared. Confirmed on the Sept 23, 2026 NatureWise stamp. Do not re-add. Do not flip. |
...
| chondroitin sulfate (as labeled inactive) — LOCKED (Sept 15, 2026) | Exact token when labeled as inactive. OCR `chonüoitin` stays refuse until a clean chondroitin panel (Sept 23, 2026). Do not map that OCR string here. |
...
| Citric acid, ascorbic acid, citrate salts (as fillers/buffers) | Citrate salts used as fillers/buffers are Cleared-by-class with citric acid (Sept 14, 2026 housekeeping). Trisodium citrate is the exact token on this same Cleared row (Sept 22, 2026). Sodium citrate dihydrate maps here (Sept 25, 2026). Sodium citrate (dihydrate) is the same Cleared lock. Not a new grade. |
...
| Dicalcium phosphate, tricalcium phosphate — **LOCKED (Sept 14, 2026 housekeeping)** | Standard mineral fillers / buffers. Not a flag. Phosphates (unnamed, this gel) sit on this same phosphate-salt Cleared-by-class (Sept 17, 2026). Dibasic sodium phosphate sits here (Sept 24, 2026). Dibasic calcium phosphate dihydrate and dicalcium phosphate dihydrate sit here (Sept 25, 2026). Tap: not phosphoric acid. Do not invent a phosphoric-acid grade. |
| Glycerin / vegetable glycerin / organic glycerin — **LOCKED (Sept 14, 2026 housekeeping)** | Standard humectant / capsule-softgel plasticizer. Not a flag. Also written glycerine (Sept 16, 2026), glycerol (Sept 22, 2026), gylcerin (Sept 24, 2026 typo), and glycerin USP / glycerine USP (Sept 25, 2026). Same Cleared row. | Distinct from Glycerol Monostearate / GMS. |
...
| Lactose, gelatin, carnauba wax, beeswax, purified water | Yellow Beeswax sits on this same wax row (Sept 16, 2026). Carnauba wax is not this Cleared row (Sept 25, 2026 Caution). Distinct from Caution synthetic beeswax. Water / bare water sit on this same purified-water row (Sept 22, 2026). Electrolyzed Water is NOT this purified-water row (Sept 17, 2026). Anhydrous lactose maps to lactose. Lactose anhydrous is the same spelling (Sept 25, 2026). Gelatin USP maps to gelatin (Sept 24, 2026). Purified water USP maps here (Sept 25, 2026). Not a new grade. |
...
| Povidone (PVP) — **LOCKED (v1.6)** | EFSA: sufficient safety margin, "unlikely to be of safety concern." Inert, non-toxic, biocompatible. Povidone USP maps here (Sept 25, 2026). Same Cleared lock. |
...
| Pregelatinized starch, corn starch, potato starch, and similar simple starches | Same profile as MCC — well-established, no concern found. Pregelantinized starch is this spelling (Sept 24, 2026). Pre-gelatinized starch is the same Cleared row (Sept 25, 2026). Bare starch as a filler maps here (Sept 25, 2026). Caution unspecified starch stays Caution. |
...
| Xanthan gum, guar gum, gum arabic / acacia, pectin, gellan gum — **LOCKED (v1.6; gellan named Sept 14, 2026)** | Standard food gums. Gellan gum is Cleared-by-class with the xanthan/guar family (one family row). Locust Bean Gum sits on this same family (Sept 16, 2026). gum arabic is the same as acacia / organic acacia gum (Sept 16, 2026 restamp). Acacia gum maps here (Sept 25, 2026). Same Cleared lock. Not Caution. Pectin as gum sits here (Sept 25, 2026). Citrus pectin maps here (Sept 25, 2026). Same Cleared lock. Gummy seed-oils stay Avoid. |
...
| Coconut oil alone in gummies/chews — **LOCKED (Sept 14, 2026 housekeeping)** | Founder restamp Sept 25, 2026: coconut oil in a gummy is Avoid, same as gummy vegetable oil. Fractionated Coconut Oil / Coconut Oil, Fractionated in a GUMMY stays this exception. Tap both sides. |
| Organic rice hull extract / rice concentrate / ground rice hulls — **LOCKED** | Plant-fiber flow agent. Distinct from rice flour. Distinct from silicon dioxide. The SiO₂ nanoparticle Caution cap does NOT apply. organic Rice hull concentrate sits on this same rice-hull family (Sept 16, 2026). |
| Organic rice bran extract — LOCKED (Sept 14, 2026) | Named rice-plant fiber used as tablet/capsule filler or flow agent. Same family as rice hull extract / rice concentrate / ground rice hulls. Distinct from silicon dioxide. Distinct from unspecified “rice extract” (Limited opacity row). Distinct from Caution organic rice bran (unspecified bran) and from Caution rice bran wax (Sept 23, 2026). Do not flip this Cleared extract row. |
...
| Organic Palm Oil as tablet / capsule coating or fill — LOCKED (Sept 16, 2026) | Exact token as tablet / capsule coating or fill. Cleared. NOT gummy High. Tap both sides: seed/industrial oils are flagged in gummies; in this coating/fill they are not that High rule. Gummy print of palm stays High. Palm Oil as tablet coating restamped Sept 16, 2026 — same row. |
...
| Medium Chain Triglycerides (derived from palm kernel oil) as capsule/liquid fill — LOCKED (Sept 16, 2026) | Exact token. Named MCT. Cleared fill. NOT gummy High. Tap vs Limited unlabeled MCT / MCT with no plant named, and vs gummy High. Distinct from Medium Chain Glycerides (Modified Coconut, Palm Oil) — both strings written. |
| Organic Medium Chain Triglycerides / Medium Chain Triglyceride (MCT) named as tablet/softgel coating or fill — LOCKED (Sept 16, 2026) | Exact tokens. Named MCT. Cleared coating / fill. NOT gummy High. Tap both sides. Distinct from Limited unlabeled MCT. |
...
| Lecithin (canola, soy, or sunflower) — **LOCKED (v1.6; canola named Sept 14, 2026)** | EFSA 2017: no safety concern, no ADI needed. Canola / soy / sunflower lecithin are the same lock — canola is already covered; this line names it. Sunflower lecithin and organic sunflower lecithin sit on this same Cleared row (Sept 22, 2026). Sunflower lecithin: no allergen concern. Soy lecithin: requires a soy-allergy note (disclosure issue, not toxicity). Canola lecithin is Cleared-class lecithin, not the gummy seed-oil High rule. Distinct from Limited bare soy (Sept 21, 2026). Do not alias bare soy to this row. Hydrogenated lecithin is its own Caution row (Sept 23, 2026). Do not alias it here. Do not flip this Cleared row. |
| Mixed tocopherols, ascorbyl palmitate (as antioxidants) — **LOCKED (v1.6)** | Long-established GRAS vitamin-E-derived antioxidants; the natural BHA/BHT alternative. No safety flags found. D-Alpha-Tocopherol as inactive sits on this same mixed-tocopherols row (Sept 16, 2026). Vitamin E as an inactive maps to tocopherol on this Cleared row (Sept 24, 2026). Distinct from Caution tocopheryl acetate. DL-alpha tocopheryl acetate is its own Cleared token (Sept 23, 2026). Do not alias bare tocopheryl acetate onto either Cleared row. |
...
| bisabolol — LOCKED (Sept 15, 2026) | Exact INCI. Cleared. Already locked — not flipped to Caution (Sept 16, 2026 restamp). |
...
| D-Alpha-Tocopherol as inactive — LOCKED (Sept 16, 2026) | Exact token as inactive. Mixed-tocopherols row. Distinct from Caution tocopheryl acetate. Also written D-Alpha Tocopherol (no hyphen; Sept 16, 2026 restamp). Both strings written. |
...
| Psyllium Husk — LOCKED (Sept 16, 2026) | Exact token. Fiber; inulin neighborhood. Cleared. |
| Oat Fiber — LOCKED (Sept 16, 2026) | Exact token. Fiber; inulin / oat neighborhood. Cleared. Distinct from Oat in oral syrup (already Cleared food soother). Distinct from Caution organic oat fiber (Sept 22, 2026). Do not flip this Cleared row. |
| Vegetable Juice Extract (Color) / Furit And Vegetable Juice Extract (Color) — LOCKED (Sept 16, 2026) | Exact tokens. Alias of named vegetable-juice-as-color. Furit is the label typo. Both strings written. |
| Lo Han Fruit Concentrate — LOCKED (Sept 16, 2026) | Exact token. Monk fruit / luo han sibling. Same Cleared row as monk fruit / mogrosides. |
| ceresin — LOCKED (Sept 16, 2026) | Exact token. Wax / petrolatum neighborhood. Cleared. Distinct from Caution synthetic beeswax. |
| special petrolatum — LOCKED (Sept 16, 2026) | Exact token. Petrolatum neighborhood. Cleared. Distinct from Cleared petrolatum / white petrolatum / ceresin. |
| Culture Media (Saccharomyces cerevisiae) / Cultured Yeast (Saccharomyces cerevisiae) / Culture Media (Molasses, Saccharomyces cerevisiae) — LOCKED (Sept 16, 2026) | Exact tokens. Ferment-media family. Cleared. Distinct from Caution organic cultured dextrose. |
| organic Rice hull concentrate — LOCKED (Sept 16, 2026) | Exact token. Rice-hull family. Cleared. Distinct from Caution rice flour / Rice Powder. |
| Agave Inulin, Powder / Organic Agave Inulin Powder — LOCKED (Sept 16, 2026) | Exact tokens. Inulin family. Cleared. |
| gum arabic — LOCKED (Sept 16, 2026 restamp) | Exact token. Same as acacia / organic acacia gum / organic gum arabic / acacia gum / Acadia. Cleared. Organic gum arabic sits on this same row (Sept 22, 2026). Acacia gum maps here (Sept 25, 2026). Acadia is this spelling (Sept 25, 2026). Same Cleared lock. Not Caution. |
| glycerine — LOCKED (Sept 16, 2026) | Exact alias of glycerin. Both strings written. Cleared. |
| Yellow Beeswax — LOCKED (Sept 16, 2026) | Exact token. Wax. Cleared. Distinct from Caution synthetic beeswax. |
...
| Calcium sulfate — LOCKED (Sept 25, 2026) | calcium sulfate, calcium sulfate anhydrous, Anhydrous Calcium Sulfate | Cleared. Same salt neighborhood as sodium sulfate. Not SLS. Not sodium coco-sulfate. |
...
| Organic raspberry — LOCKED (Sept 23, 2026) | Exact token. Cleared. Named fruit. Distinct from raspberry juice / raspberry fruit powder (color Cleared; unspecified sweetener Caution). |
| Organic raspberry powder — LOCKED (Sept 23, 2026) | Exact token. Cleared. Named fruit powder. Distinct from raspberry fruit powder on the juice-or-fruit-powder color-vs-sweetener split. Do not flip that split. |
| Blueberry juice concentrate as color — LOCKED (Sept 23, 2026) | Exact token when used as color. Cleared named juice-as-color. Distinct from Caution blueberry juice concentrate as sweetener. Distinct from the broader blueberry juice / fruit powder split. |
| Trisodium citrate — LOCKED (Sept 22, 2026) | Exact token. Cleared. Citrate-salt filler/buffer with citric acid. |
| Lemon juice concentrate as color — LOCKED (Sept 22, 2026) | Exact token when used as color. Cleared named juice-as-color. Distinct from Caution lemon juice concentrate as sweetener. |
| Sunflower oil as non-gummy fill — LOCKED (Sept 22, 2026) | Exact token as capsule / softgel / tablet fill. Named fill. Cleared. NOT gummy High. Tap both sides. Gummy print of sunflower stays High. “Annatto suspension in sunflower oil” splits here for the oil half only (Sept 23, 2026). Not a new token. Softgel fill stays Cleared. Product grade follows annatto. |
| DL-alpha tocopheryl acetate — LOCKED (Sept 23, 2026) | Exact token. Cleared. Distinct from Caution tocopheryl acetate and from Cleared D-Alpha-Tocopherol / mixed tocopherols. Do not flip the Caution tocopheryl acetate row. Do not alias bare tocopheryl acetate here. |
| C10-18 triglycerides as fill — LOCKED (Sept 23, 2026) | Exact token as capsule / softgel / tablet fill. Named fill. Cleared. NOT gummy seed-oil High. Tap both sides. Not an oil-bottle grade. |
...
| Annatto (bixin/norbixin, E160b) | Documented allergenic potential — a foundational study found 26% of chronic urticaria patients reacted, a higher rate than several synthetic dyes tested in the same study. EFSA flagged the norbixin ADI can be exceeded in high-consumer/child exposure scenarios. Exact string restamped Sept 16, 2026 (no grade change): Organic Annatto Extract (Color). Annatto extract (for color) sits on this same Caution row (Sept 22, 2026). “Annatto suspension in sunflower oil” splits into this annatto row plus Cleared sunflower-oil softgel fill (Sept 23, 2026). Not a new token. Grade follows annatto. | Standard alternatives rule (category/age/audience match). |
| Beta-carotene (as a color additive, not the vitamin) | A large French cohort study linked higher intake of natural color additives including beta-carotene to increased cancer/Type 2 diabetes rates — correlational, not proven causal, no formal IARC/NTP classification. Weak-but-real signal; do not equate with sucralose/ace-K's evidence type — this is a distinct epidemiological-correlation basis, not a genotoxicity signal. Exact string restamped Sept 16, 2026 (no grade change): Beta Carotene (For Color). Beta-carotene as color stays this Caution row (Sept 25, 2026). Bare beta-carotene maps here. Not a new grade. | Standard alternatives rule. |
| Organic Annatto Extract (Color) — LOCKED (Sept 16, 2026 restamp) | Exact string. Same Caution as annatto. No grade change. Annatto extract (for color) is the same Caution row (Sept 22, 2026). | Standard alternatives rule. Not Avoid. |
...
| Whole-leaf / crude stevia — **LOCKED (Sept 14, 2026 housekeeping)** | Do not auto-Clean. Different case from high-purity steviol glycosides (Cleared). Already stated on the Cleared row; this is the Caution row so it is not a missing-row. Distinct from Caution stevia extract (Sept 22, 2026). Stevia leaf extract does not map here (Sept 23, 2026). It maps to stevia extract. | Standard alternatives rule. Not Avoid. |
| Methacrylic acid copolymer / unnamed delayed-release composites — **LOCKED (Sept 14, 2026 housekeeping)** | Caution until specified. Enteric / delayed-release coat family. Unnamed coating blend / bare Enteric Coating sit on this same Caution row (Sept 16, 2026). Methacrylic acid and ethyl acrylate copolymer dispersion maps here (Sept 25, 2026). The same copolymer without the word dispersion maps here (Sept 25, 2026). Eudragit maps here (Sept 25, 2026). Do not invent Clean or Avoid from the coat name alone. | Standard alternatives rule. Not Avoid. |
...
| Vegetable Coating (unnamed / blank) — LOCKED (Sept 16, 2026) | Exact token when the coat is not named. Same Caution as Vegetable-Based Tablet Coating. Not the named (HPMC, glycerin) Cleared row. | Standard alternatives rule. Not Avoid. |
...
| lanolin alcohol — LOCKED (Sept 16, 2026) | Exact token. Same Caution as lanolin / wool-alcohol family. Lanolin alcohols maps here (Sept 24, 2026). Distinct from Cleared ceresin. Do not Clear. | Standard alternatives rule. Prefer a lanolin-free Good option in the same category if one exists. Do not raise to Avoid. |
...
| cedarleaf oil — LOCKED (Sept 16, 2026) | Exact token. EO / scent line. Do not alias to a different §5 oil. | Standard alternatives rule. Not Avoid. |
| nutmeg oil — LOCKED (Sept 16, 2026) | Exact token. EO / scent line. Do not alias. | Standard alternatives rule. Not Avoid. |
...
| hydrated silica (topical) — LOCKED (Sept 15, 2026) | Exact token. Topical. Distinct from the oral silicon-dioxide nanoparticle cap row and from oral hydrated silica (same oral SiO2 cap; Sept 16, 2026). Tap form. | Standard alternatives rule. Not Avoid. |
...
| tocopheryl acetate — LOCKED (Sept 15, 2026) | Exact INCI. Distinct from Cleared mixed tocopherols and from Cleared DL-alpha tocopheryl acetate (Sept 23, 2026). Do not flip this Caution row. Do not alias the bare token to the DL-alpha Cleared row. | Standard alternatives rule. Not Avoid. |
...
| polyvinyl acetate phthalate — LOCKED (Sept 15, 2026) | Exact INCI. Also written polyvinyl acetate pthalate, PVAP, and Polyvinyl Acetate Phthalates (Sept 25, 2026). Same Caution. Not a new row. | Standard alternatives rule. Not Avoid. |
...
| Mono- and Diglycerides (unspecified blend) — LOCKED (Sept 16, 2026) | Unspecified blend. Also written Mono- and Di-Glycerides (Sept 25, 2026) and mono and diglyceride of caprylic/capric acid (Sept 25, 2026). Not named GMS / glyceryl monostearate / Glycerol Monostearate (Cleared). Not Cleared medium-chain glycerides as fill. | Standard alternatives rule. Not Avoid. |
...
| seaweed extract — LOCKED (Sept 16, 2026) | Exact token. Unspecified. Named plant-color / named kelp is not this row. Tap why: label not specific. | Standard alternatives rule. Not Avoid. |
| Ginger Oil — LOCKED (Sept 16, 2026) | Exact token. EO / scent line. Distinct from ginger extract (already on the topical botanical-extract row). | Standard alternatives rule. Not Avoid. |
| Irish Moss as inactive — LOCKED (Sept 16, 2026) | Exact token as inactive. Unspecified seaweed / extract, not a named-color pass. | Standard alternatives rule. Not Avoid. |
| Evaporated Sea Water as inactive — LOCKED (Sept 16, 2026) | Exact token as inactive. Vague mineral-water line. Distinct from Trace Minerals (From Seawater). | Standard alternatives rule. Not Avoid. |
...
| mica-based pearlescent pigment — LOCKED (Sept 18, 2026) | mica-based pearlescent pigment, mica based pearlescent pigment | Exact token. Colorant. Caution. FDA 21 CFR 73.350 ≠ Clean. Mica based pearlescent pigment is this spelling (Sept 25, 2026). Same token. Not a new grade. | Standard alternatives rule. Not Avoid. |
...
| Bare sugar — LOCKED (Sept 22, 2026) | sugar (bare / unspecified), sugar spheres, sugar spheres [...] | Exact token when the label prints bare sugar. Caution. Distinct from Cleared cane sugar and from Limited beet sugar / sucrose. Sugar spheres and sugar spheres [...] map here (Sept 25, 2026). Not a new grade. | Standard alternatives rule. Not Avoid. |
...
| Organic bamboo extract — LOCKED (Sept 22, 2026) | organic bamboo extract, bamboo extract, bambusa vulgaris shoot | Exact token. Caution. Extract. Not a named-color pass. Distinct from Cleared rice hull / rice bran. Bamboo extract and bambusa vulgaris shoot map here (Sept 23, 2026). Not a new grade. | Standard alternatives rule. Not Avoid. |
| Unspecified starch — LOCKED (Sept 22, 2026) | unspecified starch, modified tapioca starchgel, cassava root | Exact token. Caution. Distinct from Limited modified starch / modified food starch and from Cleared named corn starch / potato starch / pregelatinized starch. Do not flip those rows. Modified tapioca starchgel and cassava root also map here with cassava dextrin (Sept 23, 2026). Limited modified tapioca starch stays Limited. | Standard alternatives rule. Not Avoid. |
...
| Cassava dextrin — LOCKED (Sept 22, 2026) | cassava dextrin, modified tapioca starchgel, cassava root | Exact token. Caution. Distinct from Cleared organic cassava syrup, from Caution bare dextrin, and from Limited tapioca dextrin. Modified tapioca starchgel and cassava root map here and to Caution unspecified starch (Sept 23, 2026). Limited modified starch / modified tapioca starch stays Limited. Do not flip that row. | Standard alternatives rule. Not Avoid. |
...
| Iron oxide as color — LOCKED (Sept 22, 2026) | iron oxide (as color), ferrosoferric oxide, black iron oxide, iron oxide black, red iron oxide, yellow iron oxide, ironoxide yellow | Exact token as color. Caution. Same family as iron oxides / iron oxide red / iron oxide yellow. Not Avoid. Ferrosoferric oxide and black iron oxide map here (Sept 23, 2026). Red iron oxide and yellow iron oxide map here (Sept 24, 2026). Ironoxide yellow maps here (Sept 25, 2026). Iron oxide black maps here (Sept 25, 2026). Iron oxide ochre maps here (Sept 25, 2026). Alias the family. Not a new grade. | Standard alternatives rule. Not Avoid. |
...
| Rice bran wax — LOCKED (Sept 23, 2026) | rice bran wax | Exact token. Caution. Wax. Distinct from Cleared carnauba / candelilla / sunflower seed wax, from Cleared organic rice bran extract, and from Cleared rice bran oil as fill. | Standard alternatives rule. Not Avoid. |
| Organic rice bran (unspecified bran) — LOCKED (Sept 23, 2026) | organic rice bran | Exact token when the panel prints unspecified bran. Caution. Distinct from Cleared organic rice bran extract and from Cleared rice bran oil as fill. Do not flip those Cleared rows. | Standard alternatives rule. Not Avoid. |
| Ethyl vanillin — LOCKED (Sept 23, 2026) | ethyl vanillin | Exact token. Caution. Flavor. Not a named-color pass. | Standard alternatives rule. Not Avoid. |
| Ethyl acrylate copolymer — LOCKED (Sept 23, 2026) | ethyl acrylate copolymer | Exact token. Caution. Distinct from Caution methyl acrylate and from Caution acrylate / acrylamide copolymers. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| Methacrylic acid — LOCKED (Sept 23, 2026) | methacrylic acid | Exact token. Caution. Distinct from Caution methacrylic acid copolymer / unnamed delayed-release composites. Do not flip that copolymer row. | Standard alternatives rule. Not Avoid. |
| ConcenTrace mineral complex — LOCKED (Sept 23, 2026) | ConcenTrace mineral complex | Exact token as an inactive blend. Caution. Distinct from Caution Trace Minerals (From Seawater) and from minerals under the Supplement Facts bar (actives). | Standard alternatives rule. Not Avoid. |
| Grapefruit extract — LOCKED (Sept 23, 2026) | grapefruit extract | Exact token. Caution. Extract. Distinct from Caution grapefruit oil and from Cleared citrus / grapefruit fiber. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| Organic aloe vera / powder as OI — LOCKED (Sept 23, 2026) | organic aloe vera, organic aloe vera powder, aloe barbadensis leaf extract | Exact tokens as Other Ingredient. Caution. Not a named-color pass. Aloe barbadensis leaf extract maps here (Sept 23, 2026). Not a new grade. | Standard alternatives rule. Not Avoid. |
| Bare carrot — LOCKED (Sept 23, 2026) | carrot (bare) | Exact token when the panel does not clearly say color. Caution. Black carrot / purple carrot for color stays Cleared. Do not flip that named-color row. | Standard alternatives rule. Not Avoid. |
| Cranberry / raspberry / blueberry juice or fruit powder as unspecified sweetener — LOCKED (Sept 23, 2026) | cranberry juice, raspberry juice, blueberry juice, cranberry fruit powder, raspberry fruit powder, blueberry fruit powder (sweetener) | Exact tokens when used as an unspecified sweetener. Caution. Distinct from Cleared named fruit color of the same fruits. Distinct from Limited orange fruit juice powder as sweetener. Do not flip that orange row. Cranberry fruit, organic raspberry, and organic raspberry powder stay Cleared. Do not pull those three onto this Caution row. | Standard alternatives rule. Not Avoid. |
| Blueberry juice concentrate as sweetener — LOCKED (Sept 23, 2026) | blueberry juice concentrate (sweetener) | Exact token as sweetener. Caution. Distinct from Cleared blueberry juice concentrate as color. Distinct from the broader blueberry juice / fruit powder split. | Standard alternatives rule. Not Avoid. |
| Non-silicone foam control agent — LOCKED (Sept 23, 2026) | non-silicone foam control agent | Exact token. Unspecified processing aid. Caution. Not a named antifoam. Not Avoid. | Standard alternatives rule. Not Avoid. |
| Bare turmeric as OI — LOCKED (Sept 23, 2026) | turmeric (bare, Other Ingredient) | Exact token when the panel prints bare turmeric as an Other Ingredient. Caution. Curcumin-as-color stays its own Cleared row. Oleoresin turmeric stays its own Caution row. Do not flip either. | Standard alternatives rule. Not Avoid. |
| Behenoyl polyoxyl-8 glycerides — LOCKED (Sept 23, 2026) | behenoyl polyoxyl-8 glycerides | Exact token. PEG-style glyceride. Caution. Not High. Distinct from Cleared glyceryl dibehenate and from Cleared polyoxyl castor oil. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| Cucumber extract — LOCKED (Sept 23, 2026) | cucumber extract, cucumis sativus (cucumber) fruit extract | Exact token. Caution. Extract. Not a named-color pass. Cucumis sativus (cucumber) fruit extract maps here (Sept 23, 2026). Same token. Not a new grade. | Standard alternatives rule. Not Avoid. |
| Vanilla flavor — LOCKED (Sept 23, 2026) | vanilla flavor | Exact token. Caution. Flavor. Distinct from Limited natural flavors and from Limited named lemon oil as flavor. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| Sucrose stearate / sucrose distearate — LOCKED (Sept 23, 2026) | sucrose stearate, sucrose distearate | Exact tokens. Both strings written. Caution. Sucrose-ester neighborhood with Caution sucrose fatty acid esters. Do not flip that row. Not High. | Standard alternatives rule. Not Avoid. |
| Polyoxyethylene (23) cetyl ether — LOCKED (Sept 23, 2026) | polyoxyethylene (23) cetyl ether | Exact token. PEG-ether. Caution. Not High. Distinct from Caution polyoxyl 20 cetostearyl ether. Do not flip that row. | Standard alternatives rule. Not Avoid. |
| Propylene glycol dicaprylate — LOCKED (Sept 23, 2026) | propylene glycol dicaprylate | Exact token. Caution. Distinct from Moderate propylene glycol (oral). Do not flip that row. Not High. | Standard alternatives rule. Not Avoid. |
| Hydrogenated lecithin — LOCKED (Sept 23, 2026) | hydrogenated lecithin | Exact token. Caution. Distinct from Cleared canola / soy / sunflower lecithin. Do not flip that Cleared row. | Standard alternatives rule. Not Avoid. |
| Cholesterol as OI — LOCKED (Sept 23, 2026) | cholesterol (Other Ingredient) | Exact token when labeled as Other Ingredient. Caution. Not High. | Standard alternatives rule. Not Avoid. |
...
| Pharmaceutical ink / imprinting ink — LOCKED (Sept 24, 2026) | pharmaceutical ink, imprinting ink, white ink, black edible ink | Exact tokens. Caution. Distinct from Caution edible ink and white edible ink. Do not flip those rows. White ink maps here (Sept 25, 2026). Black edible ink maps here (Sept 25, 2026). Not a new grade. Distinct from Caution white wax. | Standard alternatives rule. Not Avoid. |
| Flavor / banana flavor / flavadew coolmint — LOCKED (Sept 24, 2026) | flavor, flavors, orange flavor, Nautural Orange Flavor, natural peach flavor, natural strawberry flavor, natural raspberry flavor, natural watermelon flavor, natural blackberry flavor, peppermint flavor, assorted flavors, banana flavor, flavadew coolmint | Exact tokens. Caution. Distinct from Limited natural flavors. Do not flip that row. Flavors maps here (Sept 25, 2026). Orange flavor, peppermint flavor, and assorted flavors map here (Sept 25, 2026). Natural apple flavor and artificial blueberry flavor map here (Sept 25, 2026). Nautural Orange Flavor maps to orange flavor (Sept 25, 2026). Natural peach flavor, natural strawberry flavor, natural raspberry flavor, natural watermelon flavor, and natural blackberry flavor map here (Sept 25, 2026). Alias the family. Not a new grade. | Standard alternatives rule. Not Avoid. |
| Sorbitol sorbitan solution — LOCKED (Sept 24, 2026) | sorbitol sorbitan solution, sorbitol sorbitan solution USP, sorbitol sorbitan | Exact token. Caution. Distinct from Limited oral sorbitol and from Caution sorbitan esters. Do not flip those rows. Sorbitol sorbitan solution USP maps here (Sept 24, 2026). Sorbitol sorbitan maps here (Sept 25, 2026). Alias the family. Not a new grade. | Standard alternatives rule. Not Avoid. |
...
| Magnesium aluminum silicate — LOCKED (Sept 24, 2026) | magnesium aluminum silicate | Exact token. Caution. Distinct from Caution aluminum silicate and from Caution magnesium aluminometasilicate. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| Sodium saccharin — LOCKED (Sept 24, 2026) | sodium saccharin, saccharin sodium | Exact token. Caution. Not Avoid. Saccharin sodium maps here (Sept 25, 2026). Same token. Not a new grade. | Standard alternatives rule. Not Avoid. |
| Nonoxynol-9 — LOCKED (Sept 24, 2026) | nonoxynol-9 | Exact token. Caution. Distinct from Caution nonoxynol-30, nonoxynol-10, and bare nonoxynol. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| Benzoic acid — LOCKED (Sept 24, 2026) | benzoic acid | Exact token. Caution. Not Avoid. | Standard alternatives rule. Not Avoid. |
| Thyme oil as OI — LOCKED (Sept 24, 2026) | thyme oil | Exact token as Other Ingredient. Caution. EO / scent line. Not Avoid. | Standard alternatives rule. Not Avoid. |
| White wax — LOCKED (Sept 24, 2026) | white wax | Exact token. Caution. Distinct from Cleared beeswax / yellow beeswax and from Caution synthetic beeswax. Do not flip those rows. | Standard alternatives rule. Not Avoid. |
| C30-45 alkyl cetearyl dimethicone crosspolymer — LOCKED (Sept 24, 2026) | C30-45 alkyl cetearyl dimethicone crosspolymer | Exact token. Caution. Distinct from Caution C30-45 alkyl dimethicone / C30-45 crosspolymer. Do not flip that row. | Standard alternatives rule. Not Avoid. |
...
| Edetate disodium dihydrate — LOCKED (Sept 25, 2026) | edetate disodium dihydrate | Exact token. EDTA Caution. Distinct from Cleared disodium EDTA trace use and from Caution tetrasodium EDTA. Do not flip the trace Cleared row. | Standard alternatives rule. Not Avoid. |
| Unfiltered liquid ACV — LOCKED (Sept 25, 2026) | unfiltered liquid apple cider vinegar | Exact token. Caution. Not a named-color pass. | Standard alternatives rule. Not Avoid. |
| Purple carrot concentrate — LOCKED (Sept 25, 2026) | purple carrot concentrate, purple carrot juice, purple carrot juice concentrate | Exact tokens. Carrot color Caution. Purple Carrot (Color) exact string stays Cleared. Do not flip that named-color string. | Standard alternatives rule. Not Avoid. |
| Malt syrup — LOCKED (Sept 25, 2026) | malt syrup | Exact token. Caution. Distinct from Limited barley malt syrup. Do not flip that Limited row. | Standard alternatives rule. Not Avoid. |
| Sodium hexametaphosphate — LOCKED (Sept 25, 2026) | sodium hexametaphosphate, sodium hexametophosphate | Exact token. Caution. Sodium hexametophosphate is this spelling. Not a new grade. | Standard alternatives rule. Not Avoid. |
| Paprika extract (natural color) — LOCKED (Sept 25, 2026) | paprika extract (natural color), paprika extract | Exact token. Caution. Founder restamp from the Cleared color-only lock. Not Avoid. | Standard alternatives rule. Not Avoid. |
| Carnauba wax — LOCKED (Sept 25, 2026) | carnauba wax, carnuaba wax | Exact token. Caution. Carnuaba wax is this spelling. Carnauba wax in vegetable oil splits: this Caution wax half, plus Avoid on the gummy vegetable-oil half. Not the old Cleared wax row. | Standard alternatives rule. Not Avoid. |
| Maltitol solution — LOCKED (Sept 25, 2026) | maltitol solution | Exact token. Maltitol Caution. Distinct from Limited maltitol powder on the sugar-alcohol row. Do not flip sorbitol or mannitol. | Standard alternatives rule. Not Avoid. |
| Isomalt — LOCKED (Sept 25, 2026) | isomalt | Founder restamp. Caution. Was Limited (Sept 15). Not Avoid. | Standard alternatives rule. Not Avoid. |
...
- **Vague vs named twins in the ingredient tap.** When two label strings look related but grade differently (named hull vs “rice extract”; paprika extract vs “color added”; citrus extract vs lemon oil; seed oil in gummy vs capsule/drop), the ingredient tap must say why. Honest note stays product-level.
