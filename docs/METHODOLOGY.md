...
| Seed/industrial oils (gummies) | soybean, canola, palm, safflower, sunflower, "vegetable oil" | Clean-standard exclusion for gummy formulations. Gummy print of safflower / sunflower / palm stays High. Coconut oil alone in gummies/chews is NOT this High rule (see Cleared). Tablet / capsule / softgel / drop fill of Organic Palm Oil, High Oleic Safflower Oil, Medium Chain Glycerides, or named Medium Chain Triglycerides (derived from palm kernel oil) is NOT this High rule (see Cleared; tap both sides). Liquid-drop oil carriers and cream / topical vegetable oil use the same non-gummy rule as capsule/softgel fill; tap text required. |
