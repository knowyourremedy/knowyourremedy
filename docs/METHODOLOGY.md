...
| Citric acid, ascorbic acid, citrate salts (as fillers/buffers) | Citrate salts used as fillers/buffers are Cleared-by-class with citric acid (Sept 14, 2026 housekeeping). Trisodium citrate is the exact token on this same Cleared row (Sept 22, 2026). |
...
| Dicalcium phosphate, tricalcium phosphate — **LOCKED (Sept 14, 2026 housekeeping)** | Standard mineral fillers / buffers. Not a flag. Phosphates (unnamed, this gel) sit on this same phosphate-salt Cleared-by-class (Sept 17, 2026). Dibasic sodium phosphate sits here (Sept 24, 2026). Tap: not phosphoric acid. Do not invent a phosphoric-acid grade. |
| Glycerin / vegetable glycerin / organic glycerin — **LOCKED (Sept 14, 2026 housekeeping)** | Standard humectant / capsule-softgel plasticizer. Not a flag. Also written glycerine (Sept 16, 2026), glycerol (Sept 22, 2026), and gylcerin (Sept 24, 2026 typo). Same Cleared row. Distinct from Glycerol Monostearate / GMS. |
...
| Xanthan gum, guar gum, gum arabic / acacia, pectin, gellan gum — **LOCKED (v1.6; gellan named Sept 14, 2026)** | Standard food gums. Gellan gum is Cleared-by-class with the xanthan/guar family (one family row). Locust Bean Gum sits on this same family (Sept 16, 2026). gum arabic is the same as acacia / organic acacia gum (Sept 16, 2026 restamp). Acacia gum maps here (Sept 25, 2026). Same Cleared lock. Not Caution. Pectin as gum sits here (Sept 25, 2026). Gummy seed-oils stay Avoid. |
...
| Flavor / banana flavor / flavadew coolmint — LOCKED (Sept 24, 2026) | flavor, flavors, orange flavor, peppermint flavor, assorted flavors, banana flavor, flavadew coolmint | Exact tokens. Caution. Distinct from Limited natural flavors. Do not flip that row. Flavors maps here (Sept 25, 2026). Orange flavor, peppermint flavor, and assorted flavors map here (Sept 25, 2026). Alias the family. Not a new grade. | Standard alternatives rule. Not Avoid. |
