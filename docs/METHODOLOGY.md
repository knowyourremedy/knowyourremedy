...
| Microcrystalline cellulose, croscarmellose sodium, cellulose gum, powdered cellulose, capsule cellulose | Standard disintegrants / cellulose-family fillers. EFSA 2017: no carcinogenicity, no ADI needed. Cellulose gum, powdered cellulose, and capsule cellulose are Cleared-by-class with MCC. Microcrystalline Cellulosse is a MCC typo alias (Sept 16, 2026) — both strings written; honest note “label typo.” Microcrystallinecellulose and silicified MCC map here (Sept 25, 2026). An MCC + CMC combo maps to these two Cleared locks (Sept 24, 2026). Sodium carboxy methyl cellulose maps to cellulose gum / CMC (Sept 24, 2026). Not a new grade. |
...
| Citric acid, ascorbic acid, citrate salts (as fillers/buffers) | Citrate salts used as fillers/buffers are Cleared-by-class with citric acid (Sept 14, 2026 housekeeping). Trisodium citrate is the exact token on this same Cleared row (Sept 22, 2026). Sodium citrate dihydrate maps here (Sept 25, 2026). Not a new grade. |
...
| Bare sugar — LOCKED (Sept 22, 2026) | sugar (bare / unspecified), sugar spheres | Exact token when the label prints bare sugar. Caution. Distinct from Cleared cane sugar and from Limited beet sugar / sucrose. Sugar spheres map here (Sept 25, 2026). Not a new grade. | Standard alternatives rule. Not Avoid. |
