...
| gum arabic — LOCKED (Sept 16, 2026 restamp) | Exact token. Same as acacia / organic acacia gum / organic gum arabic. Cleared. Organic gum arabic sits on this same row (Sept 22, 2026). |
...
| Sodium saccharin — LOCKED (Sept 24, 2026) | sodium saccharin | Exact token. Caution. Not Avoid. | Standard alternatives rule. Not Avoid. |
