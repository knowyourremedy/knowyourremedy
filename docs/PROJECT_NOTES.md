...
Last Updated: September 17, 2026 (KYR5-b chunk 54 opened; do not reopen #121–#174; OI hunt also finds UPC on label photo; Thrive no_OI closeout written — batch64)
...
- KYR5 paused after PR #174 (resource-exhausted). KYR5-b chunk 54 opened (Brandon reopened). Still missing ~850 after this chunk (many dry). Do not reopen #121–#174. Does not grade. Does not invent UPCs. Does not open new product rows unless Brandon says so. Attach real codes from carton photo / PDP carousel / DailyMed / brand site onto existing Search rows. OI hunt order already on notes (carousel + Amazon + Google) also applies to finding a UPC on a label photo. GitHub Merge ≠ git pull. One PR at a time.
- KYR5-b is the barcode catch-up bot. Same rules as KYR5. Do not reopen #121–#174. Chunk 54 opened. Still missing ~850 after this chunk (many dry).
...
- Carton photo = polish.
- ~850 rows on main still need barcode backfill after KYR5-b chunk 54, many dry (KYR5 / KYR5-b). Forward catalog (KYR3) attaches UPC when the source has it.
...
Next session
- LIVE NOW: (1) Thrive no_OI stash CLOSEOUT DONE (batch64) (2) Store generics (3) Amazon 3P brands not on main. KYR5 paused after PR #174 (resource-exhausted). KYR5-b is the barcode catch-up bot. Same rules. Do not reopen #121–#174. KYR5-b chunk 54 opened. Still missing ~850 (many dry).
...
- KYR5 paused after PR #174 (resource-exhausted). KYR5-b is the barcode catch-up bot. Same rules. Do not reopen #121–#174. KYR5-b chunk 54 opened. Still missing ~850 (many dry). OI hunt order already on notes (carousel + Amazon + Google) also applies to finding a UPC on a label photo.
...
- Night barcodes = KYR5 paused after PR #174 (resource-exhausted). KYR5-b is the barcode catch-up bot. Same rules. Do not reopen #121–#174. KYR5-b chunk 54 opened. Still missing ~850 (many dry). OI hunt order already on notes (carousel + Amazon + Google) also applies to finding a UPC on a label photo.
...
- Next catalog day: store generics, then Amazon 3P. Thrive no_OI CLOSEOUT DONE (batch64). KYR5 paused after PR #174 (resource-exhausted). KYR5-b is the barcode catch-up bot. Same rules. Do not reopen #121–#174. Sprouts house stays STASHED. Do not catalog Sprouts.
