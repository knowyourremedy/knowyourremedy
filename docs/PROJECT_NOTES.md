...
Last Updated: September 21, 2026 — Nutricost Amazon 3P slice LANDED (batch76). No toothpaste. Do not edit batch70–75 product rows. Live missing UPC 100 (in-store 80 + online 20). Factory #121–#221 stay closed. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
...
- KYR6 Amazon 3P Nutricost — Sept 21, 2026 — batch76-kyr6-amazon-3p-nutricost.ts. Nutricost only. US nutricost.com supplement-facts panels are the pin (every count/strength image on the product). Search 524 (Clean 198 / Caution 315 / Avoid 11). NEW 416 / REUSE-formula 108 / SKIPPED 275 (food/pantry, protein-aisle, Pedialyte-class, merch, pet, bundles, oil pour bottles, no_OI, NutriZen, egg white, baking soda, vegan MRP) / REFUSED 296 (exact strings not on §5 — organic bamboo extract, blue spirulina (for color), beet root powder (for color), beetroot powder (for color), dextrin, starch sodium octenyl succinate, sodium caseinate, bare sugar, and the rest of the 7-step list; NO Search row). Oil/MCT/EO pour bottles stay on the hunt list (13, name+URL only). UPC omitted — no GTIN-12 decoded. Already-on-MAIN twin `nutricost-turmeric-curcumin-2300` (batch54) was not rewritten. Avoid = undisclosed caramel color, titanium dioxide, talc, synthetic dye. Rice flour / rice extract / silica / stevia / maltodextrin = Caution. Sunflower oil on a non-gummy = Cleared fill. No toothpaste. No Sprouts. No NOW. Do not edit batch70–75. Still-missing 3P leftover N=6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
