...
Last Updated: September 18, 2026 (KYR5-b set-id-only UPC backfill chunk 12 — 6 set-id-only rows filled; barcode-only gap 172; set-id-only remaining 135; online-only remaining 13; in-store 24 untouched; do not reopen #121–#201)
...
- Rows missing UPC/EAN only (may still have set-id): 172 — KYR5-b barcode-only gap after Job 2 chunk 12 (6 set-id-only rows / 8 unique UPCs; chunk 11 filled 45; chunk 10 filled 50; chunk 9 filled 50; chunk 8 filled 50; chunk 7 filled 50; chunk 6 filled 50; chunk 5 filled 50; chunk 4 filled 34; chunk 3 filled 21; chunk 2 filled 25; chunk 1 filled 42). Set-id-only remaining 135.
...
3) JOB 2 SET-ID-ONLY — chunk 12 filled 6 leftover set-id-only rows after #201 (8 unique UPC-As). Boiron leftover 30C tubes were already exhausted in chunks 5–11; shop-only other potencies stayed empty (Abies Canadensis / Ailanthus / Cheiranthus 9C; Alfalfa 6C/6X; Chenopodium 9C; Corallium Rubrum 5C; Cyclameneur non-UPC SKU; Fumaria 6X/9C; Gallicum Acidum 6C; Harpagophytum 4X/6C/7C; Luffa / Melilotus / Menyanthes 6C; Polygonum Punctatum 6X; Saponaria 6X/9C; Sempervivum 6C; Trillium Pendulum 9C; Venus Mercenaria 12C; Viola Tricolor 6C). Sambucus Nigra 6C multi-pack page stayed empty (not the single-tube Search row). Attached this chunk: Boiron Influenzinum 12C single-tube (exact Search potency, not 30C); Biofreeze cream / overnight cream / Large+XL menthol patches (Reckitt rbnainfo retail 731124, not NDC-as-GTIN; not 2-pack/3-pack); Absorbine Jr. Neck & Shoulder 7.5% (brand-site gtin12); Genexa Kids' Nighttime Cough bottle (Shopify Nighttime variant, not day+night combo sleeve). Remaining 135. Chunk 1–11 skip list still dry (Tylenol RS hospital blister NDC GTIN; Member’s Mark ES APAP; Walgreens ES dyes+talc; Dimetapp FPO; Assured Headache PM ValuHealth; Amazon day/night combo + Equate kids day+night sleeve; Sudafed PE kids check fail; CVS/Equate kids DPH FPO/zeros; Amazon dual-action / L484 pouch check fail; Coldcalm; DG mucus-DM ER / dyed APAP check fail; Tylenol For Children Plus Adults must not steal ES-liquid UPC; B&T nighttime 308079* older Mexico / barley-malt family; B&T Psoriaflora NDC-as-GTIN only; Chestal Honey / Arnicare PEG must not steal existing shea/honey twin UPCs; Equate ES / CVS ES red40 / Signature Care kids IBU dyed / up&up honey daytime / Robitussin kids leftovers — DailyMed NDC-only or no printed retail UPC). NDC-as-GTIN rejected.
