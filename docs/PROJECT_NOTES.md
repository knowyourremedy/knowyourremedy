...
Last Updated: September 23, 2026 — Nutricost batch79-refuse backfill batch80 / no NatureWise / no no_OI re-hunt. Do not edit batch76–79 rows. Live missing UPC 100 (in-store 80 + online 20). Factory #121–#221 stay closed. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense). Nutricost no_OI leftover stays 79. OUT 135 stays dead. Gummy sunflower oil and gummy vegetable oil stay Avoid.
