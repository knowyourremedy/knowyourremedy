...
Last Updated: September 21, 2026 — spirulina Caution backfill / no Nutricost / no toothpaste. Do not edit batch70–74 product rows. Do not start Nutricost. Live missing UPC 100 (in-store 80 + online 20). Factory #121–#221 stay closed. Leftover 3P still 7.
...
- Before proposing a brand, read lib/rating-drafts/ filenames. Highest rating-draft after this write is batch75. batch67 = PR #229 — do not edit. batch69 LANDED (PR #231). batch70 = Micro Ingredients first slice — do not edit. batch71 = NOW Foods — do not edit. batch72 = NOW refuse backfill — do not edit. batch73 = NOW exact-§5 BACKFILL — do not edit. batch74 = NOW token-stamp backfill — do not edit. batch75 = spirulina Caution backfill. Do not reopen batch61–74 or PR #230. Do not restage batch70–74 grades.
...
- Next catalog day: Amazon 3P leftover brand slices after NOW Foods slice (N=7). batch71 LANDED. batch70 LANDED. batch69 LANDED (PR #231). Store generics leftover closeout DONE. Thrive no_OI CLOSEOUT DONE (batch64). KYR5 / KYR5-b / KYR5-c barcode factory DONE. KYR5-d founder-lock attach. Do not reopen #121–#221. Do not reopen batch61–69 or PR #230. Sprouts house stays STASHED. Do not catalog Sprouts. Unwritten Sprouts stash ~55 is NOT in the missing-UPC set.
...
================================================================
Highest rating-draft: batch75-kyr6-spirulina-caution.ts.
batch67 = open PR #229 — do not edit that file.
batch69 LANDED (PR #231). batch70 = Micro Ingredients first slice — do not edit. batch71 = NOW Foods — do not edit. batch72 = NOW refuse backfill — do not edit. batch73 = NOW exact-§5 BACKFILL — do not edit. batch74 = NOW token-stamp backfill — do not edit. batch75 = spirulina Caution backfill. Do not reopen 61–74 / #230.
...
LIVE NOW
1) Amazon 3P leftover brand slices after NOW Foods slice — N=7: Nutricost, NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense full lines. batch73 NOW exact-§5 BACKFILL LANDED. batch72 NOW refuse backfill LANDED. batch71 NOW LANDED. batch70 Micro Ingredients LANDED (leftover MI no_OI / OUT stays in batch70 SKIPPED).
...
3) Amazon 3P leftover after NOW Foods slice — LIVE (N=7 brand slices: Nutricost, NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense). batch75 spirulina Caution backfill LANDED. batch74 LANDED. batch73 LANDED. batch72 LANDED. batch71 LANDED. batch70 LANDED.
THEN (not live)
4) Un-stash Sprouts house ≈55 + 3 refused (when Brandon walks). Do not catalog Sprouts. 187 is dead.
Do NOT mark complete: Amazon 3P. Highest rating-draft is batch75. batch67 = PR #229 — do not edit. Do not reopen batch61–74 or PR #230. Amazon house punch DONE this pass (batch63 — 35). Do not reopen batch61 / batch62. Mama Bear four + PR #118’s 18 stay closed. Thrive punch 241 + refused unlock 36 + no_OI closeout 18 are DONE. Sprouts house is STASHED (not the live job). Do not catalog Sprouts. MediNatura / B&T, Nature’s Way, and Tylenol / Advil / Aleve holes are DONE for those writes — do not list them as unstarted.
...
KYR5 factory DONE / named-dry 97/26/13 / highest draft batch75 / oils hunt-list only / do not reopen Search-post-scan-Home-Cabinet unless broken. ON MAIN / spirulina Caution backfill / leftover 3P still 7.
