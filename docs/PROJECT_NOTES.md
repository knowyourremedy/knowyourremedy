...
Last Updated: September 23, 2026 — notes catch-up #286 scoreboard / highest draft batch81 / no NatureWise. Do not edit batch76–81 rows. Amazon 3P leftover N=6: NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense. NOW + Nutricost slices closed (batch70–80 / #260–#283). Ubiquinol 240-ct is on MAIN (batch81). Nutricost no_OI leftover 79 = hunt list parked (iHerb 403 / Walmart wall / Amazon 503). Not OUT. Not refused tokens. OUT 135 stays dead. SKIPPED reports must always split no_OI vs OUT. 3P empty-UPC after #286 = 27 (blank variant or pack mismatch). Do not force a wrong pack. In-store missing UPC 73 not touched by #286. Do not mix the 73 with the 27. #285 attached 7 in-store. #286 attached 58 on batch70–80 empty UPC only. Factory #121–#221 stay closed. No toothpaste. Sprouts house stashed. Oil pour bottles hunt-list only. Do not start NatureWise.
...
- Before proposing a brand, read lib/rating-drafts/ filenames. Highest rating-draft after this write is batch81. batch67 = PR #229 — do not edit. batch69 LANDED (PR #231). batch70 = Micro Ingredients first slice — do not edit. batch71 = NOW Foods — do not edit. batch72 = NOW refuse backfill — do not edit. batch73 = NOW exact-§5 BACKFILL — do not edit. batch74 = NOW token-stamp backfill — do not edit. batch75 = spirulina Caution backfill — do not edit. batch76 = Nutricost Amazon 3P — do not edit. batch77 = Nutricost stamped-token backfill — do not edit. batch78 = Nutricost leftover-token backfill — do not edit. batch79 = Nutricost no_OI second look — do not edit. batch80 = Nutricost batch79-refuse backfill — do not edit. batch81 = Nutricost Ubiquinol 240 — do not edit. Do not reopen batch61–81 or PR #230. Do not restage batch70–80 grades. Do not start NatureWise. No toothpaste. Leftover 3P still 6. Nutricost no_OI leftover = 79. OUT 135 stays dead. Gummy sunflower oil and gummy vegetable oil stay Avoid.
...
- Next catalog day: Amazon 3P leftover brand slices after Nutricost (N=6: NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense). batch76 Nutricost LANDED. batch71 LANDED. batch70 LANDED. batch69 LANDED (PR #231). Store generics leftover closeout DONE. Thrive no_OI CLOSEOUT DONE (batch64). KYR5 / KYR5-b / KYR5-c barcode factory DONE. KYR5-d founder-lock attach. Do not reopen #121–#221. Do not reopen batch61–69 or PR #230. Sprouts house stays STASHED. Do not catalog Sprouts. Unwritten Sprouts stash ~55 is NOT in the missing-UPC set.
...
================================================================
Highest rating-draft: batch81-kyr6-nutricost-ubiquinol-240.ts.
batch67 = open PR #229 — do not edit that file.
batch69 LANDED (PR #231). batch70 = Micro Ingredients first slice — do not edit. batch71 = NOW Foods — do not edit. batch72 = NOW refuse backfill — do not edit. batch73 = NOW exact-§5 BACKFILL — do not edit. batch74 = NOW token-stamp backfill — do not edit. batch75 = spirulina Caution backfill — do not edit. batch76 = Nutricost Amazon 3P — do not edit. batch77 = Nutricost stamped-token backfill — do not edit. batch78 = Nutricost leftover-token backfill — do not edit. batch79 = Nutricost no_OI second look — do not edit. batch80 = Nutricost batch79-refuse backfill — do not edit. batch81 = Nutricost Ubiquinol 240 — do not edit. Do not reopen 61–81 / #230. Do not start NatureWise. Leftover 3P still 6. Nutricost no_OI leftover = 79. OUT 135 stays dead. Gummy sunflower oil and gummy vegetable oil stay Avoid.
...
LIVE NOW
1) Amazon 3P leftover brand slices after Nutricost — N=6: NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense full lines. batch76 Nutricost LANDED. batch75 spirulina Caution backfill LANDED. batch74 LANDED. batch73 NOW exact-§5 BACKFILL LANDED. batch72 NOW refuse backfill LANDED. batch71 NOW LANDED. batch70 Micro Ingredients LANDED (leftover MI no_OI / OUT stays in batch70 SKIPPED).
...
3) Amazon 3P leftover after Nutricost — LIVE (N=6 brand slices: NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense). batch76 Nutricost LANDED. batch75 spirulina Caution backfill LANDED. batch74 LANDED. batch73 LANDED. batch72 LANDED. batch71 LANDED. batch70 LANDED.
THEN (not live)
4) Un-stash Sprouts house ≈55 + 3 refused (when Brandon walks). Do not catalog Sprouts. 187 is dead.
Do NOT mark complete: Amazon 3P. Highest rating-draft is batch81. batch67 = PR #229 — do not edit. Do not edit batch70–81. Do not start NatureWise. Do not reopen batch61–69 or PR #230. Amazon house punch DONE this pass (batch63 — 35). Do not reopen batch61 / batch62. Mama Bear four + PR #118’s 18 stay closed. Thrive punch 241 + refused unlock 36 + no_OI closeout 18 are DONE. Sprouts house is STASHED (not the live job). Do not catalog Sprouts. MediNatura / B&T, Nature’s Way, and Tylenol / Advil / Aleve holes are DONE for those writes — do not list them as unstarted.
