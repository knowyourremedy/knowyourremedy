...
Last Updated: September 26, 2026 — founder lock GoodSense leftover tokens after #347 / notes lock #338+#346 empty-UPC / Amazon 3P leftover brands = 0 / highest draft batch110. Do not edit batch70–110 product rows. Do not edit batch109 or batch110. #347: NEW 9 / REUSE 3 / REFUSED 129 / Search 12 (Clean 0 / Caution 4 / Avoid 8). Rematch #347 is on MAIN. Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Hunt order stays DailyMed → brand site → US retailer PDP → Google AI last. AI blurb ≠ OI or UPC. NDC ≠ UPC. UPC hunt lock: 12 digits under the bars OR official spec/UPC/GTIN field / collapsed Product specifications / every count tab. Brand-site UPC text = Target spec. Allegiant catalog UPC column OK only with item code + exact count + valid check digit, not case/inner. Amazon "details UPC" on a multipack is not enough. Value pack ≠ inner bottle. #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field. 0 bar photos. Retailers added 0. Founder five attached on exact singles. Still-empty 91: 37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created. batch109: NEW 40 / REUSE 80 / SKIPPED no_OI 0 / SKIPPED OUT 144 / REFUSED 141 / Search 120 (Clean 23 / Caution 3 / Avoid 94) / no UPC (no GTIN-12 under bars). A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339 are on MAIN. Next = token backfill of mapped+stamped strings only. Factory #121–#221 closed. KYR5 #121–#221 closed. No toothpaste. Sprouts house stashed. Oil pour bottles hunt-list only. SKIPPED reports always split no_OI vs OUT.
...
- KYR5 / KYR5-b barcode factory DONE after PR #214. KYR5-c barcode-tile chunk 6 attached 1 unique UPC-A. KYR5-d / #232 attached 1 unique UPC-A (Walgreens coated ES 50-ct 311917015354). KYR5-d Tiger Balm + Biofreeze founder-lock attach: 8 unique empty Search rows. Live missing UPC = 100 is struck. Empty UPC after #338+#346: still-empty 91 (37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created). #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field (0 bar photos; retailers added 0; founder five on exact singles). Prior #312 leftover 91 = in-store 45 + 3P 46 is struck as the live hunt. Named-dry / merge-note twins 39 — do not reopen. Live Search empty count may still show ~130 because it includes those 39. Walk list A is a hunt queue only — do not treat old “72 / 101 / 130” as the count. Do not reopen #121–#221. Named dry, do not reopen: set-id 97 / in-store 26 / online 13. Unwritten Sprouts house stash ~55 is NOT in the missing-UPC set (no row yet). Does not grade. Does not invent UPCs. Does not open new product rows unless Brandon says so. Attach real codes from carton photo / PDP carousel / DailyMed / brand site onto existing Search rows. HUNT ORDER LOCK applies to OI and UPC: DailyMed → brand site → US retailer PDP → Google AI last. Never copy OI or a UPC from the AI blurb. GitHub Merge ≠ git pull. One PR at a time.
...
- Missing panel: advisor names the next SKU; Brandon hunts one-by-one. HUNT ORDER LOCK (OI and UPC, all brands, all future scans): 1) DailyMed / official label when an NDC exists. 2) Direct brand site — every count tab + every accordion + every carousel tile. 3) Other US retailer PDPs (Amazon, Target, Walmart, iHerb, Vitacost, etc.) — same tab/accordion/carousel rules. 4) LAST: Google search + AI mode / AI Overview. Use cited US links only. Never copy OI or a UPC from the AI blurb. Open the cited page and read the carton. NDC ≠ UPC. Do not invent. HTML bullets alone do not justify no_OI. Thrive leftover closeout (batch64) used Amazon carousel tiles for founder OI. Minerals under the Supplement Facts bar are actives, not Other Ingredients. No Google-LLM ingredient lists.
...
- Brand official site is step 2, after DailyMed when an NDC exists, and before any DRY. Google AI is last. Never copy OI or a UPC from the AI blurb.
...
- UPC attach lock (founder 2026-09-26, #338 + #346): 12 digits under the bars OR official spec/UPC/GTIN field / collapsed Product specifications / every count tab. Brand-site UPC text = Target spec. Allegiant catalog UPC column OK only with item code + exact count + valid check digit, not case/inner. Amazon "details UPC" on a multipack is not enough. Value pack ≠ inner bottle.
...
- TopCare high potency Vitamin C gummies: Glucose Syrup, Sugar, Water, Gelatin, 5% Fruit Juice From Concentrate (Apple, Pear, Pineapple, Peach, Orange, Lemon, Raspberry, Blackcurrant, Strawberry, Blackberry, Blueberry, Cherry), Less Than 2% of: Citric Acid, Lactic Acid, Natural Flavors, Color (Paprika Extract)
- Walgreens adult multi tablets UPC 311917199139 — full INGREDIENTS tile as founder-photographed
- up&up Extra Strength Acetaminophen PM caplets 100-ct UPC 359726863117: croscarmellose sodium, fd&c blue #1 aluminum lake, fd&c blue #2 aluminum lake, hypromelloses, magnesium stearate, microcrystalline cellulose, polyethylene glycol, polyvinyl alcohol, povidone k30, pregelatinized starch, purified water, silicon dioxide, sodium starch glycolate, talc, titanium dioxide — not the PM ointment row
- Also write if OI was logged this same hunt and is not already a row: Equate adult multi; Equate D3 50 mcg; Member’s Mark D3 50 mcg; Member’s Mark melatonin; Kirkland D3. Do not invent missing strings.
- Prior founder-logged still unwritten (do not re-ask; write in batch69 if not already a row):
...
Next session
- LIVE NOW (scoreboard after #347 / batch110): Hunt order lock stays: DailyMed → brand site → US retailer PDP → Google AI last. AI blurb ≠ OI or UPC. NDC ≠ UPC. Amazon 3P leftover brands = 0 (A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339). Next = token backfill of mapped+stamped strings only. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Do not edit batch109 or batch110. WELMATE slice closed (batch87–91). NatureWise / Nutricost / NOW / Micro Ingredients closed. Empty UPC after #338+#346: still-empty 91 (37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created). #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field (0 bar photos; retailers added 0; founder five on exact singles). Prior #312 leftover 91 = in-store 45 + 3P 46 is struck as the live hunt. Named-dry / merge-note twins 39 — do not reopen. Live Search empty count may still show ~130 because it includes those 39. #312 attached 5. #313 missing-OI rescan filled 0 / no_OI leftover 0 on that query / Sprouts OUT 1. WELMATE parked leftovers (not live 3P): empty UPC 12 from #311 list; levocetirizine 360 no pack-matched panel; WelAhead OCR. NatureWise parked: no_OI 4 + 1 empty UPC (liquid collagen berry, no count on row). SKIPPED reports always split no_OI vs OUT. Factory #121–#221 closed. No toothpaste. Sprouts house stashed (~55 unwritten, not in the 91). Oil pour bottles hunt-list only. Highest draft = batch110. Do not edit batch70–110. Do not edit batch109 or batch110. Sprouts still stashed. KYR5 #121–#221 closed. No new products. No grades.
...
- HUNT ORDER LOCK (OI and UPC, all brands, all future scans): 1) DailyMed / official label when an NDC exists. 2) Direct brand site — every count tab + every accordion + every carousel tile. 3) Other US retailer PDPs (Amazon, Target, Walmart, iHerb, Vitacost, etc.) — same tab/accordion/carousel rules. 4) LAST: Google search + AI mode / AI Overview. Use cited US links only. Never copy OI or a UPC from the AI blurb. Open the cited page and read the carton. NDC ≠ UPC. Do not invent. Amazon 3P leftover brands = 0. Next = token backfill of mapped+stamped strings only. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Do not edit batch109 or batch110. No grades. Do not edit batch files.
...
- KYR5 / KYR5-b / KYR5-c barcode factory DONE. KYR5-d founder-lock attach. Do not reopen #121–#221. Empty UPC after #338+#346: still-empty 91 (37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created). #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field (0 bar photos; retailers added 0; founder five on exact singles). Prior #312 leftover 91 = in-store 45 + 3P 46 is struck as the live hunt. Named-dry / merge-note twins 39 — do not reopen. Old counts 73 / 100 / 27 / 178 are struck as the live hunt. Named dry, do not reopen: set-id 97 / in-store 26 / online 13. HUNT ORDER LOCK applies to OI and UPC: DailyMed → brand site → US retailer PDP → Google AI last. Never copy OI or a UPC from the AI blurb.
- Before proposing a brand, read lib/rating-drafts/ filenames. Highest rating-draft after this write is batch110. batch67 = PR #229 — do not edit. batch69 LANDED (PR #231). batch70 = Micro Ingredients first slice — do not edit. batch71 = NOW Foods — do not edit. batch72 = NOW refuse backfill — do not edit. batch73 = NOW exact-§5 BACKFILL — do not edit. batch74 = NOW token-stamp backfill — do not edit. batch75 = spirulina Caution backfill — do not edit. batch76 = Nutricost Amazon 3P — do not edit. batch77 = Nutricost stamped-token backfill — do not edit. batch78 = Nutricost leftover-token backfill — do not edit. batch79 = Nutricost no_OI second look — do not edit. batch80 = Nutricost batch79-refuse backfill — do not edit. batch81 = Nutricost Ubiquinol 240 — do not edit. batch82 = NatureWise Amazon 3P — do not edit. batch83 = NatureWise leftover-token backfill — do not edit. batch84 = NatureWise fruit and foam backfill — do not edit. batch85 = NatureWise no_OI second look — do not edit. batch86 = NatureWise last-refuse backfill — do not edit. batch87 = WELMATE Amazon 3P — do not edit. batch88 = WELMATE leftover-token backfill — do not edit. batch89 = WELMATE cucumber spray — do not edit. batch90 = WELMATE no_OI second look — do not edit. batch91 = WELMATE poloxamer backfill — do not edit. batch92 = missing-OI rescan — do not edit. batch93–95 = A+Health — do not edit. batch96–105 = HealthA2Z — do not edit. batch106–108 = TIME-Cap — do not edit. batch109 = GoodSense / PR #339 — do not edit. batch110 = GoodSense rematch / #347 — do not edit. Do not reopen batch61–109 or PR #230. Do not edit batch70–110. Do not edit batch109 or batch110. Amazon 3P leftover brands = 0. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Next = token backfill of mapped+stamped strings only. WELMATE no_OI 6, NatureWise no_OI 28, and Nutricost no_OI 79 are struck as the live hunt. OUT 135 stays dead. Gummy sunflower oil and gummy vegetable oil stay Avoid.
- NOW #261 REFUSE ALIAS LOCK (founder 2026-09-20): these tokens are NOT new inactives. Map and write. Do not 7-step. Vegetarian Coating / Vegetable Coating (unnamed) = Vegetable-Based Tablet Coating Caution; Vegetarian Coating named (HPMC, glycerin) = named-coat Cleared; Carob (plain) = Carob Extract Caution unless the panel says powder-as-food only; Sucrose = existing Limited sugar; Calcium carbonate as Other Ingredient (filler) = existing mineral-filler Cleared (distinct from Ca as a labeled active); Vegetable polysaccharide capsule = HPMC / veg cap Cleared; Pharmaceutical glaze = Shellac Cleared. #261 refused 251 on token mismatch. Carob powder / powder-as-food is now Cleared (FOUNDER STAMP 2026-09-21); Carob Extract stays Caution.
- NOW TOKEN LOCK after #262 dump (founder 2026-09-20). Exact MAIN §5 only. No family guesses. WRITE / map to existing table: sodium ascorbate → ascorbate antioxidant family Cleared; calcium citrate → citrate salts fillers/buffers Cleared; Ca carbonate as OI filler (already locked); Mg / K / ammonium / Na carbonate or bicarbonate → bicarb / mineral-filler Cleared; potassium chloride + potassium sulfate → saline/mineral salt with bicarb Cleared; soy lecithin + sunflower lecithin phospholipids → lecithin Cleared; beeswax → yellow beeswax Cleared; named MCT / medium-chain triglycerides as fill → named MCT fill Cleared; psyllium husk → Psyllium Husk Cleared (sesame traces = allergen copy only); citrus / grapefruit / bergamot fiber → fiber + pectin Cleared; riboflavin for color → riboflavin-as-color Cleared; lycopene → lycopene color Cleared; pyridoxine HCl → B6 as inactive Cleared; organic beet sugar + sucrose → Limited sugar Caution; xylitol oral + organic erythritol oral → oral polyol Caution; calcium silicate → calcium silicate Caution (≠ silica Cleared); unspecified rice / organic rice powder → Rice Powder Caution; natural lemon oil as flavor → lemon oil flavor Caution; ginger root + cinnamon bark powder → ginger/cinnamon botanical Caution; peppermint leaf powder → unspecified botanical powder Caution (peppermint oil flavor stays Cleared); green tea extract leaf → unspecified/tea extract Caution. Prior 7-STEP park list is now FOUNDER STAMP 2026-09-21 leftover tokens. Old spirulina refuse is now FOUNDER STAMP 2026-09-21 Spirulina Caution (see next bullets). batch73 LANDED the exact-§5 NOW backfill (SKUs that failed ONLY on this WRITE list). batch74 LANDED the Sept 21 leftover-token backfill. Nutricost batch76 LANDED after this lock. Do not edit batch70–75 rows. Do not reopen Nutricost.
- FOUNDER STAMP 2026-09-21 — NOW leftover tokens (exact §4). Caution (Limited): Sodium coco-sulfate (same irritant class as SLS; not High); Fulvic acid as OI; Sorghum powder (unspecified grain powder; ≠ named hull); Chlorella powder (unspecified algae); Non-fat dry milk; Bare soy (lecithin stays Cleared); Bare wheat; Orange fruit juice powder as sweetener (≠ juice-as-color); Sustained-release caffeine as OI. Cleared (0): Polyglyceryl-10 laurate; Flax seed oil as fill/OI (named oil fill; not gummy High; not oil-bottle grade); Cocoa powder (≠ cocoa butter; ≠ extract); Phytosterols from soy, highly refined; Taurine as OI; L-arginine as OI; Nicotinamide as OI; Cyanocobalamin as OI; Carob powder / powder-as-food (Carob Extract stays Caution). batch74 LANDED the leftover-token backfill. Spirulina later locked Caution (see next bullet). Nutricost later landed as batch76. Do not edit batch70–75 product rows. Do not reopen Nutricost.
- FOUNDER STAMP 2026-09-21 — Spirulina. Spirulina powder as OI / blend = Caution (Limited). Unspecified algae + contamination class. Same neighborhood as chlorella powder. Spirulina extract as OI / color in a multi = Caution. FDA color allow ≠ Clean. Not Avoid. Not Cleared. Reopens the old TopCare + NOW spirulina refuse. batch75 wrote the NOW powder packs and EVE tablets. TopCare adult + Women’s gummies stay REFUSED: exact string `Spirulina` (not spirulina powder / spirulina extract) and exact string `Palm Oil` / `Palm oil` (gummy; no graded oils). Nutricost batch76 LANDED after this stamp. Blue spirulina (for color) is its own Caution row (FOUNDER STAMP 2026-09-22). No toothpaste. Do not edit batch76 rows. Do not start NatureWise.
- FOUNDER STAMP 2026-09-22 — Nutricost batch76 clean tokens. Caution: blue spirulina (for color); bare sugar; sodium caseinate; dextrin; starch sodium octenyl succinate; organic bamboo extract; unspecified starch; zinc oxide as OI. Cleared: beet root / beetroot powder (for color); Himalayan rock salt; pure olive oil as fill. Soybean oil stays the existing form split (gummy/lozenge Avoid; fill/cream Cleared). SKIPPED reports must split no_OI vs OUT. Nutricost no_OI = 140 hunt list. OUT = 135 dead. batch77 wrote the stamped-token backfill. Do not edit batch76–77 rows. No NatureWise. No toothpaste.
- FOUNDER STAMP 2026-09-22 — Nutricost leftover clean tokens (MAIN methodology + SOURCES). Caution: bare spirulina (for color); cassava dextrin; glucose; stevia extract; hydrogenated vegetable oil as OI (gummy fat blend still Avoid). Cleared: grape (fruit) powder (for color); cocoa powder alkali; choline chloride as OI. Avoid: titanium oxide when it is titanium dioxide. OCR junk stays refuse. no_OI 140 was the hunt list. batch78 wrote the leftover-token backfill. batch79 hunted that no_OI list (leftover 79). Do not edit batch76–79 rows. No NatureWise. No toothpaste.
- Nutricost no_OI second look DONE (batch79). Search 47 (Clean 21 / Caution 22 / Avoid 4). NEW 42 / REUSE-formula 5 / SKIPPED 91 (no_OI leftover 79 / already on MAIN 5 / OUT 7) / REFUSED 9. OUT 135 was not reopened. The 7 OUT rows are bleed found while opening no_OI names (pantry fenugreek, celery seed, two pomegranate powders, plant food coloring, vegan MRP, mass gainer). Leftover 3P still 6. Do not start NatureWise.
- FOUNDER STAMP 2026-09-22 — batch79 refuse strings (use existing §5 where named). Map: annatto extract → annatto; glycerol → glycerin; water → water; gum arabic → gum arabic; sunflower lecithin → lecithin; sunflower oil non-gummy → named fill Cleared (gummy sunflower stays High). New exact: iron oxide as color Caution; trisodium citrate Cleared; lemon juice concentrate Caution as sweetener / Cleared as color; pea starch Caution (was Limited); organic oat fiber Caution (Oat Fiber stays Cleared). Do not edit batch76–79 rows. No NatureWise.
- KYR6 Nutricost batch79-refuse backfill DONE (batch80). Search 9 (Clean 0 / Caution 9 / Avoid 0). NEW 8 / REUSE-formula 1 (marshmallow 120 shares batch77 butcher's broom) / SKIPPED 1 (CoQ10 100 mg 120 softgels already on MAIN) / REFUSED 1 at write (Ubiquinol 240-count tab: `annatto suspension in sunflower oil`). Cordyceps 90 stays the batch79 row. no_OI leftover stays 79. Leftover 3P still 6. Gummy sunflower oil and gummy vegetable oil stay Avoid. Do not edit batch76–80 rows. Do not start NatureWise.
- FOUNDER STAMP 2026-09-23 — “annatto suspension in sunflower oil” = annatto + sunflower oil fill. Split the clause. Not a new token. Softgel fill stays Cleared. Grade follows annatto. Gummy sunflower oil stays High. Do not edit batch76–80 rows. No NatureWise.
- KYR6 Nutricost Ubiquinol 240 DONE (batch81). Search 1 (Clean 0 / Caution 1 / Avoid 0). NEW 1 / REUSE-formula 0 / SKIPPED 0 / REFUSED 0. Search grade Caution. The 240-count panel prints `annatto suspension in sunflower oil` and does not match the batch80 120 list, so the row is NEW (`nutricost-b81-ubiquinol-240-softgels`). UPC-A 810014679044 printed on the 240-count front label. no_OI leftover stays 79. Leftover 3P still 6. Gummy sunflower oil and gummy vegetable oil stay Avoid. Do not edit batch76–81 rows. Do not start NatureWise.
- FOUNDER STAMP 2026-09-23 — NatureWise batch82 clean tokens. Map: bamboo extract + bambusa vulgaris shoot → organic bamboo extract Caution. Map: modified tapioca starchgel / cassava root → cassava dextrin / starch Caution. Limited modified starch / modified tapioca starch stays Limited. Corn oil keeps the oil form split (gummy Avoid; fill Cleared). Caution: rice bran wax; organic rice bran (unspecified bran); ethyl vanillin; ethyl acrylate copolymer; methacrylic acid; ConcenTrace mineral complex; grapefruit extract; organic aloe vera / powder as OI; bare carrot unless clearly color. Cleared: triethyl citrate (already locked); potassium acetate. Cranberry / raspberry / blueberry juice or fruit powder: Cleared as named fruit color; Caution as unspecified sweetener. NatureWise no_OI 28 and leftover N=5 with WELMATE are struck as the live hunt. Do not edit batch70–82 product rows. No toothpaste.
- FOUNDER STAMP 2026-09-23 — NatureWise leftover fruit / foam. Cleared: cranberry fruit; organic raspberry; organic raspberry powder. Blueberry juice concentrate: Cleared as color; Caution as sweetener. Caution: non-silicone foam control agent (unspecified processing aid). Distinct from the cranberry / raspberry / blueberry juice-or-fruit-powder color-vs-sweetener split. Do not flip that split. batch83 is on MAIN. Do not edit batch70–83 product rows. No next 3P brand. No toothpaste. Leftover 3P N=5.
- FOUNDER STAMP 2026-09-23 — NatureWise last refuse. stevia leaf extract → existing stevia extract Caution. Not whole-leaf. Not Reb A / Reb M. Bare turmeric as OI Caution. Curcumin-as-color stays its own row. Oleoresin turmeric stays its own row. Behenoyl polyoxyl-8 glycerides Caution (PEG-style glyceride; not High). batch84 and batch85 are on MAIN. Do not edit batch70–85 product rows. No WELMATE. No toothpaste.
...
- FOUNDER STAMP 2026-09-25 — HealthA2Z leftover maps. lactose anhydrous → lactose; ironoxide yellow → iron oxide; pre-gelatinized starch → pregelatinized starch; macrogol + polyethylene glylcol → PEG; white ink → pharmaceutical ink Caution; flavors → flavor Caution; shellac wax → shellac Caution; light liquid paraffin → paraffin / mineral-oil Caution. Caution: sorbitol special; dextrates; sorbitan monooleate; potassium hydroxide. Cleared: pectin as gum (gummy seed-oils still Avoid). Dual-panel day/night stays no-row. Do not edit batch70–98 product rows. No TIME-Cap. No GoodSense.
- FOUNDER STAMP 2026-09-25 — HealthA2Z alias families. iron oxide black / black iron oxide / ironoxide yellow / red iron oxide → iron oxide Caution. FD&C yellow # 6 aluminum lake / FD&Cyellow #6 / Yellow 6 lake → Yellow 6 Avoid. orange flavor / peppermint flavor / assorted flavors / flavors → flavor Caution. acacia gum → acacia / gum arabic (existing Cleared lock; do not flip to Caution). saccharin sodium → sodium saccharin Caution. sorbitol sorbitan → sorbitol sorbitan solution Caution. black edible ink → pharmaceutical ink Caution. Dual-panel day/night stays no-row. Omeprazole coating: map only exact locked polymer names; leftover unknown coating strings stay refuse. Do not edit batch70–100 product rows. No TIME-Cap. No GoodSense.
- FOUNDER STAMP 2026-09-25 — HealthA2Z alias families 2. dibasic / dicalcium phosphate dihydrate → Ca phosphate Cleared; microcrystallinecellulose → MCC; D&C Yellow 10 / yellow 5 / blue 1 / FD&C blue #1 brilliant blue lake → those dyes Avoid; iron oxide ochre → iron oxide Caution; bare starch → filler Cleared; sodium citrate dihydrate → citrate Cleared; edetate disodium dihydrate → EDTA Caution; glycerine / glycerin USP / PEG-400 USP / povidone USP / purified water USP / sorbitol 70% solution USP → those locks; methacrylic acid and ethyl acrylate copolymer dispersion → existing copolymer Caution; silicified MCC → MCC; sugar spheres → sugar Caution; Mono- and Di-Glycerides → Caution; natural apple / artificial blueberry flavor → flavor Caution; unfiltered liquid ACV / purple carrot concentrate / Malt syrup → Caution; citrus pectin → pectin Cleared; sodium hexametophosphate → hexametaphosphate Caution; beta-carotene as color → Caution. Do not edit batch70–101 product rows. No TIME-Cap.
- FOUNDER STAMP 2026-09-25 — HealthA2Z exact leftovers. sodium citrate (dihydrate) → citrate Cleared; polyethylene glycol-400 USP → PEG; silicified microcrystalline cellulose → MCC; sugar spheres [...] / sugar spheres → sugar Caution; bare beta-carotene → beta-carotene as color Caution. Do not edit batch70–102 product rows. No TIME-Cap.
- FOUNDER STAMP 2026-09-25 — HealthA2Z gummy stamps. Nautural Orange Flavor → orange flavor Caution. Natural peach / strawberry / raspberry / watermelon / blackberry flavor → flavor Caution. Paprika extract (natural color) → paprika extract Caution. Purple carrot juice / juice concentrate → carrot color Caution. Carnuaba wax / carnauba wax in vegetable oil → carnauba Caution + gummy vegetable oil Avoid. Maltitol solution → maltitol Caution. Isomalt → Caution. Coconut oil in a gummy → Avoid (same as gummy veg oil). Do not edit batch70–104 product rows. No TIME-Cap.
- FOUNDER STAMP 2026-09-25 — TIME-Cap refuse maps. eudragit → methacrylic enteric Caution. methacrylic acid and ethyl acrylate copolymer (no dispersion) → same copolymer Caution. polyethylene glycol (peg) 8000 / polyethylene glycol 6000 / PEG 6000 / PEG 8000 → PEG. colloidal silicone dioxide → silica / SiO2. mono and diglyceride of caprylic/capric acid → mono/diglycerides Caution. calcium sulfate / calcium sulfate anhydrous / Anhydrous Calcium Sulfate → Ca sulfate Cleared. Acadia → acacia (existing Cleared lock; do not flip to Caution). Polyvinyl Acetate Phthalates → PVAP Caution. Do not edit batch70–106 product rows. No GoodSense.
- NOTES LOCK 2026-09-26 — #338 + #346 empty-UPC. #338 retailer-ladder: attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text: attached 56 from a2z-life.com UPC field. 0 bar photos. Retailers added 0. Founder five attached on exact singles. Still-empty 91: 37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created. UPC hunt lock: 12 digits under the bars OR official spec/UPC/GTIN field / collapsed Product specifications / every count tab. Brand-site UPC text = Target spec. Allegiant catalog UPC column OK only with item code + exact count + valid check digit, not case/inner. Amazon "details UPC" on a multipack is not enough. Value pack ≠ inner bottle. Amazon 3P leftover brands = 0 (A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339). batch109: NEW 40 / REUSE 80 / SKIPPED no_OI 0 / SKIPPED OUT 144 / REFUSED 141 / Search 120 (Clean 23 / Caution 3 / Avoid 94) / no UPC (no GTIN-12 under bars). Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Likely already-locked (existing locks only — not a new grade): cetyl alcohol, cetearyl alcohol, disodium EDTA, C30-45 alkyl cetearyl dimethicone crosspolymer, sodium carbonate, potassium bicarbonate, beta-carotene (color), colloidal silicon dioxide. Likely DailyMed split junk: "and titanium dioxide", "natural and artificial", "sucrose and water", "sucralose and water", "inactive ingradients calcium carbonate", "may contain pharmaceutical ink". Sprouts still stashed. KYR5 #121–#221 closed. Next = token backfill of mapped+stamped strings only. Do not edit batch109 or batch110. No GoodSense write. No grades this pass.
- FOUNDER STAMP 2026-09-26 — GoodSense leftover tokens after #347 rematch. MAP (not new grades): anhydrous citric acid → citric acid Cleared (hydration; same as sodium citrate dihydrate); sorbitol solution + noncrystallizing sorbitol solution → Limited oral sorbitol (distinct from Caution sorbitol sorbitan solution and Caution sorbitol special; do not flip those rows); tribasic sodium phosphate + monobasic sodium phosphate + sodium phosphate monobasic dihydrate → phosphate-salt Cleared-by-class (not phosphoric acid; do not invent a phosphoric-acid grade); anhydrous dibasic calcium phosphate → calcium phosphate Cleared; edetate disodium → EDTA Caution with edetate disodium dihydrate (do not assume Cleared disodium EDTA trace; do not flip the trace row); low substituted hydroxypropyl cellulose + low-substituted hydroxypropyl cellulose → HPC Cleared (HPMC family; hyphen is spelling); sorn syrup solids → corn syrup solids (label typo); maltitol syrup → maltitol solution Caution (distinct from Limited maltitol powder); sorbitan → sorbitan esters Caution (not sorbitol); confectioner's sugar → bare sugar Caution. NEW stamps: high fructose corn syrup = Caution (§5 food-only park closed; on real GoodSense inactives; neighbor = sugar/glucose Caution, not gummy-oil Avoid); corn syrup + corn syrup solids = Caution (same sweetener neighborhood); gum base = Caution (unnamed elastomer/resin/wax blend). Menthol / menthol-dl / eucalyptus oil stay parked as topical actives. If DailyMed Active — drop refuse, no §5 stamp. If truly Inactive (lozenge flavor) — flavor Caution. Bot checks the panel header. Do not invent a menthol-inactive class. Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). #347 scoreboard: NEW 9 / REUSE 3 / REFUSED 129 / Search 12 (Clean 0 / Caution 4 / Avoid 8). Highest draft after rematch = batch110. Next = token backfill of mapped+stamped strings only. Do not edit batch109 or batch110. Sprouts still stashed. KYR5 #121–#221 closed.
...
- HUNT ORDER LOCK (OI and UPC, all brands, all future scans): 1) DailyMed / official label when an NDC exists. 2) Direct brand site — every count tab + every accordion + every carousel tile. 3) Other US retailer PDPs (Amazon, Target, Walmart, iHerb, Vitacost, etc.) — same tab/accordion/carousel rules. 4) LAST: Google search + AI mode / AI Overview. Use cited US links only. Never copy OI or a UPC from the AI blurb. Open the cited page and read the carton. NDC ≠ UPC. Do not invent. HTML bullets alone do not justify no_OI. Thrive leftover closeout (batch64) used Amazon carousel tiles for founder OI. Amazon house and all later store punches use this.
- Store PDPs are first-class sources — sprouts.com + Instacart / DoorDash / Uber Eats for Sprouts house; Walmart / Target / CVS / Amazon / grocery for other brands. Use them for Other Ingredients AND UPC/EAN. Exact pack only (brand + name + form + strength + count). Specs / details / carousel / barcode tile. HTML bullets alone ≠ missing. NDC ≠ UPC. No UPC on the page ≠ invent one. Next catalog pile (store generics) uses this hunt on write, not a later factory.
- Brand official site is step 2, after DailyMed when an NDC exists, and before any DRY. Google AI is last. Never copy OI or a UPC from the AI blurb.
- Example: Boiron pellets → boironusa.com product page. Read every carousel tile AND the 12 digits under the bars (3 06960 …). NDC on the carton is not a UPC.
- Do not call a row dry if the brand site has a carton photo with bars.
...
- Next catalog day: Amazon 3P leftover brands = 0 (A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339). Next = token backfill of mapped+stamped strings only. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Do not edit batch109 or batch110. WELMATE slice closed. NatureWise / Nutricost / NOW / Micro Ingredients closed. NatureWise no_OI 28 is struck as the live hunt. batch76 Nutricost LANDED. batch71 LANDED. batch70 LANDED. batch69 LANDED (PR #231). Store generics leftover closeout DONE. Thrive no_OI CLOSEOUT DONE (batch64). KYR5 / KYR5-b / KYR5-c barcode factory DONE. KYR5-d founder-lock attach. Do not reopen #121–#221. Do not reopen batch61–69 or PR #230. Sprouts house stays STASHED. Do not catalog Sprouts. Unwritten Sprouts stash ~55 is NOT in the missing-UPC set.
...
- Highest rating-draft after this write is batch69. batch67 = PR #229 — do not edit. batch69 LANDED (PR #231). Do not reopen batch65 / 66 / 67 / 68 or PR #230.
- Founder carousel hunt Sept 16, 2026 — live OI in advisor thread. Gallery HTML-zero is not “no label.” Carousel tiles are OI and UPC.
- Missing panel hunt follows the HUNT ORDER LOCK: 1) DailyMed / official label when an NDC exists. 2) Direct brand site — every count tab + every accordion + every carousel tile. 3) Other US retailer PDPs — same tab/accordion/carousel rules. 4) LAST: Google search + AI mode / AI Overview. Use cited US links only. Never copy OI or a UPC from the AI blurb. Open the cited page and read the carton. NDC ≠ UPC. Do not invent. HTML bullets alone do not justify no_OI. Thrive leftover closeout (batch64) used Amazon carousel tiles for founder OI. Minerals under the Supplement Facts bar are actives, not Other Ingredients. No Google-LLM ingredient lists.
...
- KYR6 NOW refuse backfill — Sept 21, 2026 — batch72-kyr6-now-refuse-backfill.ts. NOW only. Unlock #261 refuse tokens now aliased on MAIN (unnamed Vegetarian/Vegetable Coating Caution; named HPMC+glycerin coat Cleared; plain Carob = Carob Extract Caution; Sucrose Limited; Ca carbonate OI filler Cleared; veg polysaccharide capsule = HPMC Cleared; pharmaceutical glaze = Shellac Cleared). Search 111 (Clean 11 / Caution 99 / Avoid 1 caramel). NEW 82 / REUSE-formula 29 / SKIPPED already-written batch71 705 / REFUSED 24 at write. Founder 2026-09-20 NOW TOKEN LOCK after #262 dump: exact MAIN §5 WRITE/map list + spirulina still refused + 7-step park (see Next session). Later KYR6 may backfill NOW SKUs that failed ONLY on the WRITE list. Do not backfill 7-step or spirulina. Do not edit batch70–72 rows. Do not start Nutricost. Leftover 3P still 7.
- KYR6 NOW exact-§5 BACKFILL — Sept 21, 2026 — batch73-kyr6-now-exact-s5-backfill.ts. NOW only. Write SKUs that failed ONLY on the #262 WRITE list (ascorbate / citrates / carbonates-bicarbonates / KCl-K sulfate / lecithin / beeswax / named MCT fill / psyllium husk / citrus-grapefruit-bergamot fiber / riboflavin color / lycopene color / B6 inactive / beet sugar-sucrose / oral xylitol-erythritol / calcium silicate Caution / rice powder Caution / lemon oil flavor / ginger-cinnamon botanical / peppermint leaf powder / green tea extract). Search 27 (Clean 9 / Caution 17 / Avoid 1 caramel). NEW 15 / REUSE-formula 12 / SKIPPED already-written batch71 705 + batch72 111 / REFUSED mixed or still-unknown at write (spirulina / 7-step / cinnamon bark oil / chewable corn oil / no current 15-cap D3 pin). Founder 2026-09-21 leftover NOW tokens now stamped on MAIN §5 (see Next session). Spirulina stays refused. Do not edit batch70–73 rows. Do not start Nutricost. Leftover 3P still 7.
- KYR6 spirulina Caution BACKFILL — Sept 21, 2026 — batch75-kyr6-spirulina-caution.ts. NOW only. Write rows previously refused on spirulina powder or spirulina extract, now Caution (Limited) on MAIN §5. Search 4 (Clean 0 / Caution 4 / Avoid 0). NEW 2 (organic spirulina powder 1 lb; EVE tablets 180) / REUSE-formula 2 (powder 4 oz → `now-organic-spirulina-powder-1`; EVE tablets 90 → `now-eve-superior-womens-multi-180-tablets`) / SKIPPED already-written batch71 705 + batch72 111 + batch73 27 + batch74 23 + batch71 `now-spirulina-120` capsules + flax pour bottles on the hunt list / REFUSED TopCare adult + Women’s gummies: exact string `Spirulina` (not spirulina powder / spirulina extract) and exact string `Palm Oil` / `Palm oil` (gummy; no graded oils). No toothpaste. Do not edit batch70–74 rows. Do not start Nutricost. Leftover 3P still 7.
- KYR6 Nutricost Ubiquinol 240 — Sept 23, 2026 — batch81-kyr6-nutricost-ubiquinol-240.ts. Nutricost only. One SKU: Ubiquinol Softgels 240-count tab that batch80 refused. Panel re-read on nutricost.com (image NTC_Ubiquinol_100MG_240SFG_500CC_SFP_Square.jpg). Printed other ingredients: MCT oil (medium chain triglycerides), gelatin, glycerine, ascorbyl palmitate, purified water, beeswax, sunflower lecithin, annatto suspension in sunflower oil. Founder split of that clause: annatto → existing annatto Caution; sunflower oil → existing softgel fill Cleared. Not a new token. Search 1 (Clean 0 / Caution 1 / Avoid 0). NEW 1 / REUSE-formula 0 (printed list is not the batch80 120 list, which prints sunflower oil and annatto extract (for color) as two tokens) / SKIPPED 0 / REFUSED 0. Search grade Caution. UPC-A 810014679044 printed on the 240-count front label on the same PDP. batch76–80 files untouched. no_OI leftover stays 79. No NatureWise. No toothpaste. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
- KYR6 Nutricost batch79-refuse backfill — Sept 23, 2026 — batch80-kyr6-nutricost-79-refuse.ts. Nutricost only. Wrote the 9 BATCH79_REFUSED SKUs after the Sept 22 stamps. Panels re-read on nutricost.com (every count/strength SFP opened). Search 9 (Clean 0 / Caution 9 / Avoid 0). NEW 8 / REUSE-formula 1 (marshmallow 120 shares batch77 `nutricost-butcher-s-broom-extract-capsules-120-capsules`) / SKIPPED 1 (CoQ10 100 mg 120 softgels already batch76) / REFUSED 1 at write (Ubiquinol 240-count tab exact string `annatto suspension in sunflower oil` — not split at write). FOUNDER STAMP 2026-09-23: split that clause into annatto + sunflower oil fill. Not a new token. Softgel fill stays Cleared. Grade follows annatto. Do not edit batch76–80 rows. Cordyceps 90 stays the batch79 row. Kids fiber gummy does not print sunflower oil or vegetable oil (Caution on natural flavors). Gummy sunflower oil and gummy vegetable oil stay Avoid. no_OI leftover stays 79. batch76–79 files untouched. No UPC attached. No NatureWise. No toothpaste. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
- KYR6 Nutricost no_OI second look — Sept 23, 2026 — batch79-kyr6-nutricost-no-oi.ts. Nutricost only. Hunted the batch76 SKIPPED no_OI list (140). Pin = nutricost.com supplement-facts image read before the write. iHerb search 403. Walmart search robot wall. Vitacost search had no product PDP. Amazon search HTML loaded; Amazon image carousels were not opened SKU-by-SKU for the leftover set. Search 47 (Clean 21 / Caution 22 / Avoid 4). NEW 42 / REUSE-formula 5 (cinnamon 150 shares the 240 formula; beef liver 120 shares the 240 formula; ALA 240 shares the 120 formula; unflavored BCAA 90 shares batch76 `nutricost-nutricost-bcaa-powder-30-servings`; turmeric 90 shares batch76 `nutricost-nutricost-turmeric-capsules-120-capsules`) / SKIPPED 91 (no_OI leftover 79 / already on MAIN 5 / OUT 7) / REFUSED 9 at write (organic lemon juice concentrate; annatto extract (for color); iron oxide + glycerol; trisodium citrate + bare water; organic oat fiber / organic gum arabic / organic sunflower lecithin; FOUNDER STAMP 2026-09-22 maps these onto existing §5 plus the new exacts — see Next session. Do not edit batch76–79 rows. organic pea starch / organic oat fiber / organic sunflower oil; cordyceps 180-cap count tab). OUT 135 was not reopened. batch76–78 files untouched. No UPC attached. No NatureWise. No toothpaste. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
- KYR6 Nutricost leftover-token BACKFILL — Sept 23, 2026 — batch78-kyr6-nutricost-token-backfill-2.ts. Nutricost only. Wrote batch77 REFUSED rows whose blocking tokens are now stamped on MAIN §5 (grape (fruit) powder (for color); bare spirulina (for color); stevia extract; titanium oxide → existing titanium dioxide Avoid; cassava dextrin; bare glucose; cocoa powder (processed with alkali); hydrogenated vegetable oil as OI; choline chloride as OI) plus the batch76 multi-collagen hot cocoa and vitamin D3 gummy rows still blocked only by those tokens. The Pre-X maltodextrin-grape line was a line wrap of maltodextrin + grape (fruit) powder (for color). Search 21 (Clean 0 / Caution 18 / Avoid 3). NEW 18 / REUSE-formula 3 (BCAA grape 60 / 90 / 120 share the 30-serving grape formula) / SKIPPED 1 (no_OI 0 / OUT 0 / other 1 — C8 unflavored 1 lb has no supplement-facts image) / REFUSED 0. OCR junk left refused (not aliased). Other ingredients None stays the batch77 skip. Gummy hydrogenated-vegetable-oil fat blend stays Avoid; the D3 gummy vegetable oil is the existing gummy High row. batch76 and batch77 files untouched. No UPC attached. No NatureWise. No toothpaste. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
- KYR6 Nutricost stamped-token BACKFILL — Sept 22, 2026 — batch77-kyr6-nutricost-token-backfill.ts. Nutricost only. Wrote batch76 REFUSED rows whose blocking tokens are now stamped on MAIN §5 (blue spirulina (for color); bare sugar; sodium caseinate; dextrin; starch sodium octenyl succinate; organic bamboo extract exact only; unspecified starch; zinc oxide as OI; beet root / beetroot powder (for color); Himalayan rock salt; pure olive oil as fill). Soybean oil uses the existing form split (softgel fill Cleared). Search 118 (Clean 2 / Caution 109 / Avoid 7). NEW 87 / REUSE-formula 31 / SKIPPED 3 (no_OI 0 / OUT 0 — the 3 are count tabs that print Other ingredients: None) / REFUSED 20 (still-missing exact tokens: grape (fruit) powder (for color); spirulina (for color) without blue; stevia extract; titanium oxide; cassava dextrin; bare glucose; cocoa powder (processed with alkali); hydrogenated vegetable oil; choline chloride). OCR-garbage strings were not aliased. OCR junk stays refuse. Batch76 no_OI 140 stays hunt list (was not hunted). Batch76 OUT 135 was not reopened. batch76 file untouched. No UPC attached. FOUNDER STAMP 2026-09-22 leftover clean tokens now on MAIN §5 (see Next session). Do not edit batch76–77 rows. Do not start NatureWise. Leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
- KYR6 Amazon 3P Nutricost — Sept 21, 2026 — batch76-kyr6-amazon-3p-nutricost.ts. Nutricost only. US nutricost.com supplement-facts panels are the pin (every count/strength image on the product). Search 524 (Clean 198 / Caution 315 / Avoid 11). NEW 416 / REUSE-formula 108 / SKIPPED 275 must split: no_OI 140 hunt list / OUT 135 dead (food/pantry, protein-aisle, Pedialyte-class, merch, pet, bundles, oil pour bottles, NutriZen, egg white, baking soda, vegan MRP). REFUSED 296 at write (exact strings not on §5 — organic bamboo extract, blue spirulina (for color), beet root powder (for color), beetroot powder (for color), dextrin, starch sodium octenyl succinate, sodium caseinate, bare sugar, and the rest of the 7-step list; NO Search row). FOUNDER STAMP 2026-09-22 clean tokens now on MAIN §5 (see Next session). Oil/MCT/EO pour bottles stay on the hunt list (13, name+URL only). UPC omitted — no GTIN-12 decoded. Already-on-MAIN twin `nutricost-turmeric-curcumin-2300` (batch54) was not rewritten. Avoid = undisclosed caramel color, titanium dioxide, talc, synthetic dye. Rice flour / rice extract / silica / stevia / maltodextrin = Caution. Sunflower oil on a non-gummy = Cleared fill. Soybean oil stays the existing form split. No toothpaste. No Sprouts. No NOW. Do not edit batch76 rows. Do not start NatureWise. Still-missing 3P leftover N=6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense).
- KYR6 NOW token-stamp BACKFILL — Sept 21, 2026 — batch74-kyr6-now-token-stamp-backfill.ts. NOW only. Write SKUs held for the Sept 21 founder stamps (fulvic acid OI, sorghum powder, chlorella powder, non-fat dry milk, orange fruit juice powder as sweetener, sustained-release caffeine as OI, flax seed oil as fill, cocoa powder, highly refined soy phytosterols, taurine, l-arginine, nicotinamide, cyanocobalamin, carob powder). Search 23 (Clean 0 / Caution 20 / Avoid 3 caramel). NEW 18 / REUSE-formula 5 (prostate 90, SAMe 30, chlorella 4 oz, omega 100, saw palmetto 240 → batch71 `now-saw-palmetto-extract-160-mg-120`) / SKIPPED already-written batch71 705 + batch72 111 + batch73 27 + flax pour bottles on the hunt list / REFUSED at write: spirulina powder 1 lb + 4 oz and spirulina extract on EVE tablets 180 + 90 (no row — now FOUNDER STAMP 2026-09-21 Spirulina Caution; later KYR6 only, not this notes patch); sodium coco-sulfate toothpastes that still print hydrated silica / stevia rebaudiana extract / xylitol (25%)* / natural favor / papain / cinnamon leaf oil; Colloidal Minerals Raspberry still-unknown `stevia extract (leaf)`. Bare soy and bare wheat had no writable inactive (Saw 240 wheat/soy words are the absence line). Polyglyceryl-10 laurate had no current writable PDP. Sodium coco-sulfate had no row that was only that stamp. Do not edit batch70–74 rows. Do not start Nutricost. No toothpaste. Leftover 3P still 7.
...
================================================================
Highest rating-draft: batch110-kyr6b-goodsense-rematch.ts. Do not edit batch109 or batch110.
batch67 = open PR #229 — do not edit that file.
batch69 LANDED (PR #231). batch70 = Micro Ingredients first slice — do not edit. batch71 = NOW Foods — do not edit. batch72 = NOW refuse backfill — do not edit. batch73 = NOW exact-§5 BACKFILL — do not edit. batch74 = NOW token-stamp backfill — do not edit. batch75 = spirulina Caution backfill — do not edit. batch76 = Nutricost Amazon 3P — do not edit. batch77 = Nutricost stamped-token backfill — do not edit. batch78 = Nutricost leftover-token backfill — do not edit. batch79 = Nutricost no_OI second look — do not edit. batch80 = Nutricost batch79-refuse backfill — do not edit. batch81 = Nutricost Ubiquinol 240 — do not edit. batch82 = NatureWise Amazon 3P — do not edit. batch83 = NatureWise leftover-token backfill — do not edit. batch84 = NatureWise fruit and foam backfill — do not edit. batch85 = NatureWise no_OI second look — do not edit. batch86 = NatureWise last-refuse backfill — do not edit. batch87 = WELMATE Amazon 3P — do not edit. batch88 = WELMATE leftover-token backfill — do not edit. batch89 = WELMATE cucumber spray — do not edit. batch90 = WELMATE no_OI second look — do not edit. batch91 = WELMATE poloxamer backfill — do not edit. batch92 = missing-OI rescan — do not edit. batch93–95 = A+Health — do not edit. batch96–105 = HealthA2Z — do not edit. batch106–108 = TIME-Cap — do not edit. batch109 = GoodSense / PR #339 — do not edit. batch110 = GoodSense rematch / #347 — do not edit. Do not reopen 61–109 / #230. Do not edit batch70–110. Do not edit batch109 or batch110. Amazon 3P leftover brands = 0. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Next = token backfill of mapped+stamped strings only. WELMATE no_OI 6, NatureWise no_OI 28, and Nutricost no_OI 79 are struck as the live hunt. OUT 135 stays dead. Gummy sunflower oil and gummy vegetable oil stay Avoid.
...
- Kirkland Wild Alaskan FO 1400 Clean UPC 096619653539
...
- Ethyl vanillin: §5 Caution (FOUNDER STAMP 2026-09-23). Not a refuse.
- Mineral / ionic drops IN.
- Bandages OUT. Oil bottles hunt-list only.
...
LIVE NOW
1) Amazon 3P leftover brands = 0 (A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339). Next = token backfill of mapped+stamped strings only. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Do not edit batch109 or batch110. WELMATE slice closed (batch87–91). NatureWise / Nutricost / NOW / Micro Ingredients closed. NatureWise no_OI 28, WELMATE no_OI 6, and Nutricost no_OI 79 are struck as the live hunt. batch76 Nutricost LANDED. batch75 spirulina Caution backfill LANDED. batch74 LANDED. batch73 NOW exact-§5 BACKFILL LANDED. batch72 NOW refuse backfill LANDED. batch71 NOW LANDED. batch70 Micro Ingredients LANDED (leftover MI no_OI / OUT stays in batch70 SKIPPED).
...
Empty UPC after #338+#346: still-empty 91 (37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created). #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field (0 bar photos; retailers added 0; founder five on exact singles). Prior #312 leftover 91 = in-store 45 + 3P 46 is struck as the live hunt. Named-dry / merge-note twins 39 — do not reopen. Old counts 73 / 100 / 27 / 178 are struck as the live hunt. #285 attached 7 in-store. #286 attached 58 on batch70–80 empty UPC only. Named dry: set-id 97 / in-store 26 / online 13.
KYR4 photos on paste only. Cron OFF.

PROCESS
- Sidebar first. No bot paste until Brandon says go.
- Cursor notes BEFORE catalog-bot paste.
- One job. Last line STILL WORKING / ON MAIN / WAITING / STOPPED.
- Advisor does not push GitHub.
- Main wins over pins.
...
3) Amazon 3P leftover brands = 0 (A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339). Next = token backfill of mapped+stamped strings only. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Do not edit batch109 or batch110. WELMATE slice closed. NatureWise no_OI 28 is struck as the live hunt. batch76 Nutricost LANDED. batch75 spirulina Caution backfill LANDED. batch74 LANDED. batch73 LANDED. batch72 LANDED. batch71 LANDED. batch70 LANDED.
THEN (not live)
4) Un-stash Sprouts house ≈55 + 3 refused (when Brandon walks). Do not catalog Sprouts. 187 is dead.
Amazon 3P leftover brands = 0 — the four brands are on MAIN. GoodSense rematch #347 is on MAIN (batch110). Highest rating-draft is batch110. batch67 = PR #229 — do not edit. Do not edit batch70–110. Do not edit batch109 or batch110. Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Next = token backfill of mapped+stamped strings only. Do not reopen batch61–69 or PR #230. Amazon house punch DONE this pass (batch63 — 35). Do not reopen batch61 / batch62. Mama Bear four + PR #118’s 18 stay closed. Thrive punch 241 + refused unlock 36 + no_OI closeout 18 are DONE. Sprouts house is STASHED (not the live job). Do not catalog Sprouts. MediNatura / B&T, Nature’s Way, and Tylenol / Advil / Aleve holes are DONE for those writes — do not list them as unstarted.
...
PARKED, STAYS PARKED unless the founder revisits: remaining formaldehyde-releasers (imidazolidinyl urea, Quaternium-15, Bronidox, Bronopol). DMDM hydantoin / diazolidinyl urea are Caution (formaldehyde-donor, Sept 15) — not Avoid. HFCS is un-parked (Sept 26, 2026 Caution; on real GoodSense inactives; neighbor = sugar/glucose Caution, not gummy-oil Avoid). Zinc as a nutrient/active stays parked (active-safety-cap, not the inactive table). Menthol / menthol-dl / eucalyptus oil stay parked as topical actives: DailyMed Active → drop refuse, no §5 stamp; Inactive lozenge flavor → flavor Caution. Bot checks the panel header. Do not invent a menthol-inactive class. Camphor stays pending (young-children look).
...
================================================================
Last Updated: September 26, 2026 — #347 rematch on MAIN (batch110: NEW 9 / REUSE 3 / REFUSED 129 / Search 12 (Clean 0 / Caution 4 / Avoid 8)) / scoreboard after #338+#346 / batch109. Next = token backfill of mapped+stamped strings only. Do not edit batch109 or batch110. Amazon 3P leftover brands = 0 (A+Health 93–95, HealthA2Z 96–105, TIME-Cap 106–108, GoodSense 109 / PR #339). Empty UPC after #338+#346: still-empty 91. #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field. 0 bar photos. Retailers added 0. Founder five attached on exact singles. Still-empty 91: 37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created. Prior #312 leftover 91 = in-store 45 + 3P 46 is struck as the live hunt. Named-dry / merge-note twins 39 — do not reopen. batch109: NEW 40 / REUSE 80 / SKIPPED no_OI 0 / SKIPPED OUT 144 / REFUSED 141 / Search 120 (Clean 23 / Caution 3 / Avoid 94) / no UPC (no GTIN-12 under bars). Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Next = token backfill of mapped+stamped strings only. Sprouts still stashed. KYR5 #121–#221 closed. Do not edit batch109 or batch110. Old live counts 73 / 100 / 101 / 122 / 178 and 3P empty 27 are struck.

#338 + #346 empty-UPC lock (Sept 26, 2026)
- #338 retailer-ladder: attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576).
- #346 spec-text: attached 56 from a2z-life.com UPC field. 0 bar photos. Retailers added 0. Founder five attached on exact singles. Still-empty 91: 37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created.
- UPC hunt lock: 12 digits under the bars OR official spec/UPC/GTIN field / collapsed Product specifications / every count tab. Brand-site UPC text = Target spec. Allegiant catalog UPC column OK only with item code + exact count + valid check digit, not case/inner. Amazon "details UPC" on a multipack is not enough. Value pack ≠ inner bottle.
- GoodSense batch109 scoreboard (do not edit the file): NEW 40 / REUSE 80 / SKIPPED no_OI 0 / SKIPPED OUT 144 / REFUSED 141 / Search 120 (Clean 23 / Caution 3 / Avoid 94) / no UPC (no GTIN-12 under bars).
- Rematch #347 is on MAIN (batch110). Do not stamp the rest of the #347 list (dextrose, polycarbophil, meglumine, phosphoric acid, etc.). Likely already-locked (existing locks only — not a new grade): cetyl alcohol, cetearyl alcohol, disodium EDTA, C30-45 alkyl cetearyl dimethicone crosspolymer, sodium carbonate, potassium bicarbonate, beta-carotene (color), colloidal silicon dioxide. Likely DailyMed split junk: "and titanium dioxide", "natural and artificial", "sucrose and water", "sucralose and water", "inactive ingradients calcium carbonate", "may contain pharmaceutical ink".
- Next = token backfill of mapped+stamped strings only. Sprouts still stashed. KYR5 #121–#221 closed. No GoodSense write this notes pass. No grades this pass.

Prior in-store pass (struck as the live count): missing 178 is not the live hunt. Prior #312 leftover (struck as the live hunt): 91 = in-store 45 + 3P 46. Live empty UPC is the #338+#346 still-empty 91 above.
...
- Search rows: 2241
- Rows with UPC: 2140
- Live missing UPC = 100 is struck. Empty UPC after #338+#346: still-empty 91 (37 value pack / 24×N stay empty; TIME-Cap/Timely printed 0 usable; fluticasone 144-spray shared-tab + 2-pack skipped; no-count cetirizine/aspirin skipped; 24 no-row packs not created). #338 retailer-ladder attached 34 (13 bar photo / 1 Target spec / 20 Allegiant UPC column). Value-pack inner-bottle codes not attached (fexo 24×30, famotidine 24×50, DPH 24 vs 576). #346 spec-text attached 56 from a2z-life.com UPC field (0 bar photos; retailers added 0; founder five on exact singles). Prior #312 leftover 91 = in-store 45 + 3P 46 is struck as the live hunt. Named-dry / merge-note twins 39 — do not reopen. Live Search empty count may still show ~130 because it includes those 39.
...
- ALL-SITE accordion lock (2026-09-19): expand every collapsed accordion (Product Specifications / Details / More specs / Product details / Shipping & specs / Nutrition / Supplement facts extra tabs / “show more”) before DRY. Do not DRY off first-paint hero + Drug Facts alone. 11-digit retailer UPC is valid input (GTIN-12 minus check digit). Store UPC-A = 11 digits + GS1 check digit (31191705853 → 311917058535; same as #232 31191701535 → 311917015354). If 12 digits already show, store those 12 after a check-digit sanity pass. Click/expand all collapsibles on walgreens.com, walmart.com, target.com, cvs.com, samsclub.com, dollargeneral.com, amazon.com, and brand sites. Read 12 digits under bars when a barcode image exists. NDC ≠ UPC. Official brand site + every tile + every accordion, then DRY. UPC attach lock (founder 2026-09-26, #338 + #346): 12 digits under the bars OR official spec/UPC/GTIN field / collapsed Product specifications / every count tab. Brand-site UPC text = Target spec. Allegiant catalog UPC column OK only with item code + exact count + valid check digit, not case/inner. Amazon "details UPC" on a multipack is not enough. Value pack ≠ inner bottle.
...
- Newly attached 8 empty Search rows:
  - tiger-balm-muscle-rub 039278440201
  - tiger-balm-neck-shoulder-rub 039278421019
  - tiger-balm-pain-relieving-patch 039278322002
  - tiger-balm-hydrogel-patch 039278322002
  - tiger-balm-cool-patch 039278322002
  - biofreeze-pain-relief-spray-10-5-denatonium 731124000109
  - biofreeze-professional-aerosol-10-5-denatonium 359316120200
  - biofreeze-professional-spray-13 731124445216
- Already-had (not overwritten):
  - tiger-balm-active-muscle-rub 039278440201
  - tiger-balm-neck-shoulder-vanishing-scent 039278421019
  - tiger-balm-pain-relieving-patch-regular-hydrogel 039278322002
  - tiger-balm-hydrogel-patch-large 039278323009
  - biofreeze-pain-relief-gel-4 includes 731124000033 (3 oz gel tube; not moved — already on gel, not 10% spray)
  - biofreeze-pain-relief-spray-10-5 731124000071 731124001146
...
- ~~Tiger Balm — Tiger Balm Pain Relieving Cool Patch — patch — Camphor (synthetic) 80 mg/patch; Menthol 24 mg/patch — count unknown~~ CLOSED — 039278322002 (5-ct 4x2.75)
...
- Absorbine Jr. — Absorbine Jr. PRO Roll-On Liquid 4% — roll-on — Menthol 4% — count unknown
Aspercreme (3)
- Aspercreme — Aspercreme Arthritis Pain Gel (no fragrance) — gel — Diclofenac sodium 1% — count unknown
...
- Newly attached 8 empty Search rows:
  ...
  - healtha2z-ibuprofen-200-335 369168335301 369168335349 (a2z-life.com field "UPC:" on 24×30; Amazon 3×30 field "UPC". Brand-printed GTIN-12; same NDC-derived pattern as already-on-MAIN 382 369168466050 — not a DailyMed NDC copied into barcode)
  - teemofe-lidocaine-4-patch 762501440944 (40-ct; field "UPC")
  - dg-health-ibuprofen-tablets 359726235259 370030167425 (DG PDP productDetails.upc 24-ct coated + 100-ct tablets; not 50-ct dyed+talc 370030015290)
- Already-had (not overwritten):
...
KYR5-d Walgreens Ibuprofen 200 mg proof case (Sept 20, 2026)
- Existing empty MAIN IBU rows: none except dye-free (already-had). Tablets / caplets / brown / gels = no-row.
- walgreens-ibuprofen-dye-free already-had 311917089324 — not overwritten.
- No-row (valid UPC-A; no exact empty Search row): tablets 100-ct 311917204789 (ID=300429191 spec); tablets 500-ct 311917177649 (archive hub ID=300443683 Product Specs 11-digit 31191717764 + GS1); tablets 1000-ct 311917204505 (archive skuId=400650886 11-digit 31191720450 + GS1). Site example 1000-ct 31191717762 → 311917177625 also no-row.
- No-row (prior indexed specs): caplets 500-ct 311917204802; caplets 24-ct 311917148922.
- Softgels / mini-gels / brown coat: no empty MAIN row; no attachable unique UPC hung.
...
KYR5 factory DONE / named-dry 97/26/13 / highest draft batch76 / oils hunt-list only / do not reopen Search-post-scan-Home-Cabinet unless broken. ON MAIN / Nutricost Amazon 3P / leftover 3P still 6.
ON MAIN / Nutricost Amazon 3P batch76 / leftover 3P still 6 (NatureWise, WELMATE, A+Health, HealthA2Z, TIME-Cap, GoodSense)
...
NOW exact-§5 BACKFILL LANDED (batch73) / spirulina still refused / leftover 3P still 7 / no Nutricost.
NOW token-stamp BACKFILL LANDED (batch74) / leftover 3P still 7 / no Nutricost.
ON MAIN / NOW token-stamp backfill / leftover 3P still 7.
ON MAIN / spirulina Caution locked / STOPPED
ON MAIN / spirulina Caution backfill / leftover 3P still 7
ON MAIN / Nutricost clean tokens stamped / STOPPED
ON MAIN / Nutricost stamped-token backfill batch77 / leftover 3P still 6 / do not start NatureWise
ON MAIN / Nutricost leftover tokens stamped / STOPPED
ON MAIN / Nutricost leftover-token backfill batch78 / leftover 3P still 6 / do not start NatureWise
ON MAIN / Nutricost no_OI second look batch79 / no_OI leftover 79 / OUT 135 dead / leftover 3P still 6 / do not start NatureWise
ON MAIN / batch79 refuse mapped / STOPPED
ON MAIN / Nutricost batch79-refuse backfill batch80 / no_OI leftover 79 / leftover 3P still 6 / gummy sunflower and vegetable oil stay Avoid / do not start NatureWise
ON MAIN / annatto-sunflower clause split / STOPPED
ON MAIN / Nutricost Ubiquinol 240 batch81 / Caution / NEW 1 / REUSE 0 / SKIPPED 0 / REFUSED 0 / leftover 3P still 6 / do not start NatureWise
ON MAIN / notes catch-up #286 scoreboard / STOPPED
ON MAIN / NatureWise tokens stamped / STOPPED
ON MAIN / NatureWise fruit+foam stamped / STOPPED
ON MAIN / NatureWise last refuse stamped / STOPPED
ON MAIN / WELMATE tokens stamped / STOPPED
...
ON MAIN / HealthA2Z leftover maps / STOPPED
ON MAIN / HealthA2Z alias families / STOPPED
ON MAIN / HealthA2Z alias families 2 / STOPPED
ON MAIN / HealthA2Z exact leftovers / STOPPED
ON MAIN / HealthA2Z gummy stamps / STOPPED
ON MAIN / TIME-Cap maps stamped / STOPPED
ON MAIN / notes lock #338+#346 empty-UPC / Amazon 3P leftover brands = 0 / batch109 scoreboard / GoodSense rematch next / STOPPED
ON MAIN / GoodSense leftover tokens stamped after #347 / batch110 / token backfill next / STOPPED
