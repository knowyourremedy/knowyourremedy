...
const CONDITION_LINKS = [
  { label: 'Allergies', href: '/conditions/allergies' },
  { label: 'Anxiety & Stress', href: '/conditions/anxiety-and-stress' },
  { label: 'Back Pain', href: '/conditions/back-pain' },
  { label: 'Bloating & Gas', href: '/conditions/bloating-and-gas' },
  { label: 'Burns & Sunburn', href: '/conditions/burns-and-sunburn' },
  { label: 'Cold & Flu', href: '/conditions/cold-and-flu' },
...
export default function ConditionPageLayout({
  title,
  subtitle,
  emergency,
  naturalItems,
    ...
    <ConditionLayout>
      ...
      <style>{`
        @media (min-width: 768px) {
          .condition-sidebar { display: block !important; }
        }
      `}</style>
